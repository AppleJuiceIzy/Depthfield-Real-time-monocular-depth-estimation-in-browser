...
"[project]/lib/gestureClassifier.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createHandLandmarker() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mediapipe$2f$tasks$2d$vision$2f$vision_bundle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HandLandmarker"].createFromOptions(vision, {
        baseOptions: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gestureClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gestureClassifier.ts [app-client] (ecmascript)");
...
function DepthViewer() {
    ...
    const handsActiveRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true);
    const handsInFlightRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const lastHandsTsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const handsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    const gestureHistoryRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    ...
    const [handsEnabled, setHandsEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [handsCount, setHandsCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [activeGesture, setActiveGesture] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("none");
    const [activeGestureConfidence, setActiveGestureConfidence] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [activeHandDepth, setActiveHandDepth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const drawHands = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DepthViewer.useCallback[drawHands]": (rgbCtx)=>{
    ...
    }["DepthViewer.useCallback[drawHands]"], [
        depthToStrokeColor
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DepthViewer.useEffect": ()=>{
            ...
            if (handsEnabled) {
                void (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$handTracker$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initHandTracker"])().catch({
                    "DepthViewer.useEffect": (error)=>{
                    ...
                    if (video && rgbCanvas && video.readyState >= 2) {
                        ...
                        if (rgbCtx) {
                            ...
                            if (handsActiveRef.current && !handsInFlightRef.current && now - lastHandsTsRef.current >= HAND_INTERVAL_MS) {
                                ...
                                void (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$handTracker$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["detectHands"])(video, now).then({
                                    "DepthViewer.useEffect.draw": (result)=>{
                                        const fusedHands = result.landmarks.map({
                                            "DepthViewer.useEffect.draw.fusedHands": (handLandmarks)=>{
                                                const points = handLandmarks.map({
                                                    "DepthViewer.useEffect.draw.fusedHands.points": (landmark)=>({
                                                            landmark,
                                                            depth: sampleDepthAt(landmark.x, landmark.y)
                                                        })
                                                }["DepthViewer.useEffect.draw.fusedHands.points"]);
                                                const avg = points.reduce({
                                                    "DepthViewer.useEffect.draw.fusedHands": (acc, p)=>acc + (Number.isFinite(p.depth) ? p.depth : 0)
                                                }["DepthViewer.useEffect.draw.fusedHands"], 0) / Math.max(1, points.length);
                                                return {
                                                    points,
                                                    averageDepth: avg,
                                                    gesture: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gestureClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["classifyGesture"])(handLandmarks)
                                                };
                                            }
                                        }["DepthViewer.useEffect.draw.fusedHands"]);
                                        handsRef.current = fusedHands;
                                        setHandsCount(fusedHands.length);
                                        const bestGesture = fusedHands.map({
                                            "DepthViewer.useEffect.draw": (h)=>h.gesture
                                        }["DepthViewer.useEffect.draw"]).sort({
                                            "DepthViewer.useEffect.draw": (a, b)=>b.confidence - a.confidence
                                        }["DepthViewer.useEffect.draw"]).find({
                                            "DepthViewer.useEffect.draw": (g)=>g.label !== "none"
                                        }["DepthViewer.useEffect.draw"]) ?? {
                                            label: "none",
                                            confidence: 0
                                        };
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        handsEnabled && activeGesture !== "none" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            style: {
                                                position: "absolute",
                                                top: 14,
                                                left: "50%",
...
_s(DepthViewer, "LZGyjo6UcVNctbfDYKndIIp9sBk=");
_c = DepthViewer;
var _c;
...
//# sourceMappingURL=_0p2j9.9._.js.map