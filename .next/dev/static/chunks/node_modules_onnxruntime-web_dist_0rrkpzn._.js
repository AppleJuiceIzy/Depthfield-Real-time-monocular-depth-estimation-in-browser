...
"[project]/node_modules/onnxruntime-web/dist/ort.bundle.min.mjs (static in ecmascript, tag client)", ((__turbopack_context__) => {

__turbopack_context__.q("/_next/static/media/ort.bundle.min.00cx-q.bmnl2..mjs");}),
"[project]/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm (static in ecmascript, tag client)", ((__turbopack_context__) => {

__turbopack_context__.q("/_next/static/media/ort-wasm-simd-threaded.jsep.0._ck368a-7hh.wasm");}),
...
var Gn = ((t1)=>("TURBOPACK compile-time value", "function") < "u" ? /*TURBOPACK member replacement*/ __turbopack_context__.z : typeof Proxy < "u" ? new Proxy(t1, {
    ...
    throw Error('Dynamic require of "' + t1 + '" is not supported');
});
var V = (t1, e)=>()=>(t1 && (e = t1(t1 = 0)), e);
var Vt = (t1, e)=>{
    for(var r in e)Wn(t1, r, {
        get: e[r],
        enumerable: !0
    });
}, bf = (t1, e, r, n)=>{
    if (e && typeof e == "object" || typeof e == "function") for (let o of hf(e))!gf.call(t1, o) && o !== r && Wn(t1, o, {
        get: ()=>e[o],
        enumerable: !(n = ff(e, o)) || n.enumerable
    });
    return t1;
};
var Xt = (t1)=>bf(Wn({}, "__esModule", {
        value: !0
    }), t1);
var xr, Et, kt, yf, Oa, Hn = V(()=>{
    "use strict";
    xr = new Map, Et = [], kt = (t1, e, r)=>{
        if (e && typeof e.init == "function" && typeof e.createInferenceSessionHandler == "function") {
            let n = xr.get(t1);
            if (n === void 0) xr.set(t1, {
                backend: e,
                priority: r
            });
            else {
                if (n.priority > r) return;
                if (n.priority === r && n.backend !== e) throw new Error(`cannot register backend "${t1}" using priority ${r}`);
            }
            if (r >= 0) {
                let o = Et.indexOf(t1);
                o !== -1 && Et.splice(o, 1);
        ...
        if (e.aborted) return e.error;
        {
            let r = !!e.initPromise;
            try {
                return r || (e.initPromise = e.backend.init(t1)), await e.initPromise, e.initialized = !0, e.backend;
            } catch (n) {
        ...
        let e = t1.executionProviders || [], r = e.map((d)=>typeof d == "string" ? d : d.name), n = r.length === 0 ? Et : r, o, i = [], s = new Set;
        for (let d of n){
            let c = await yf(d);
...
var Ma, Oe, Fn = V(()=>{
    ...
    Object.defineProperty(Oe, "logLevel", {
        enumerable: !0
    });
});
var _e, Ra = V(()=>{
...
var Ua, Na, Va = V(()=>{
    ...
    Ua = (t1, e)=>{
        ...
        r.width = t1.dims[3], r.height = t1.dims[2];
        let n = r.getContext("2d");
        if (n != null) {
            let o, i;
            e?.tensorLayout !== void 0 && e.tensorLayout === "NHWC" ? (o = t1.dims[2], i = t1.dims[3]) : (o = t1.dims[3], i = t1.dims[2]);
            ...
            for(let _ = 0; _ < i; _++)for(let T = 0; T < o; T++){
                let x = (t1.data[m++] - c[0]) * d[0], $ = (t1.data[g++] - c[1]) * d[1], S = (t1.data[y++] - c[2]) * d[2], I = b === -1 ? 255 : (t1.data[b++] - c[3]) * d[3];
        ...
        if (r != null) {
            let o, i, s;
            e?.tensorLayout !== void 0 && e.tensorLayout === "NHWC" ? (o = t1.dims[2], i = t1.dims[1], s = t1.dims[3]) : (o = t1.dims[3], i = t1.dims[2], s = t1.dims[1]);
            ...
            for(let E = 0; E < i * o; y += g, b += g, _ += g, T += g, E++)n.data[y] = (t1.data[x++] - p[0]) * c[0], n.data[b] = (t1.data[$++] - p[1]) * c[1], n.data[_] = (t1.data[S++] - p[2]) * c[2], n.data[T] = I === -1 ? 255 : (t1.data[I++] - p[3]) * c[3];
        } else throw new Error("Can not access image data");
        return n;
    };
});
var qn, La, Wa, Ga, Ha, Fa, qa = V(()=>{
    ...
    Sr();
    qn = (t1, e)=>{
        if (t1 === void 0) throw new Error("Image buffer must be defined");
        ...
        for(let E = 0; E < c; E++, g += m, b += m, y += m, _ += m)p[T++] = (t1[g] + s[0]) / i[0], p[x++] = (t1[y] + s[1]) / i[1], p[$++] = (t1[b] + s[2]) / i[2], S !== -1 && _ !== -1 && (p[S++] = (t1[_] + s[3]) / i[3]);
        ...
        let r = typeof HTMLImageElement < "u" && t1 instanceof HTMLImageElement, n = typeof ImageData < "u" && t1 instanceof ImageData, o = typeof ImageBitmap < "u" && t1 instanceof ImageBitmap, i = typeof t1 == "string", s, u = e ?? {}, d = ()=>{
        ...
        if (r) {
            let p = d();
            p.width = t1.width, p.height = t1.height;
            let m = c(p);
            if (m != null) {
                let g = t1.height, y = t1.width;
                ...
                m.drawImage(t1, 0, 0), s = m.getImageData(0, 0, y, g).data;
            } else throw new Error("Can not access image data");
        } else if (n) {
            let p, m;
            if (e !== void 0 && e.resizedWidth !== void 0 && e.resizedHeight !== void 0 ? (p = e.resizedHeight, m = e.resizedWidth) : (p = t1.height, m = t1.width), e !== void 0 && (u = e), u.format = "RGBA", u.height = p, u.width = m, e !== void 0) {
                let g = d();
                g.width = m, g.height = p;
                let y = c(g);
                if (y != null) y.putImageData(t1, 0, 0), s = y.getImageData(0, 0, m, p).data;
                else throw new Error("Can not access image data");
            } else s = t1.data;
        } else if (o) {
            ...
            if (m != null) {
                let g = t1.height, y = t1.width;
                return m.drawImage(t1, 0, 0, y, g), s = m.getImageData(0, 0, y, g).data, u.height = g, u.width = y, qn(s, u);
            } else throw new Error("Can not access image data");
        } else {
            if (i) return new Promise((p, m)=>{
                ...
                if (!t1 || !y) return m();
                let b = new Image;
                b.crossOrigin = "Anonymous", b.src = t1, b.onload = ()=>{
...
var Pt, Jt, Ka, ja, Za = V(()=>{
    ...
    Pt = new Map([
        ...
        if (!Ka) {
            Ka = !0;
            let t1 = typeof BigInt64Array < "u" && BigInt64Array.from, e = typeof BigUint64Array < "u" && BigUint64Array.from, r = globalThis.Float16Array, n = typeof r < "u" && r.from;
            t1 && (Pt.set("int64", BigInt64Array), Jt.set(BigInt64Array, "int64")), e && (Pt.set("uint64", BigUint64Array), Jt.set(BigUint64Array, "uint64")), n ? (Pt.set("float16", r), Jt.set(r, "float16")) : Pt.set("float16", Uint16Array);
        }
    };
});
var Qa, Ya, Xa = V(()=>{
    ...
    Qa = (t1)=>{
        ...
        switch(t1.location){
            case "cpu":
                return new Be(t1.type, t1.data, e);
            case "cpu-pinned":
                return new Be({
                    location: "cpu-pinned",
                    data: t1.data,
            ...
            case "ml-tensor":
                return new Be({
                    location: "ml-tensor",
                    mlTensor: t1.mlTensor,
                    type: t1.type,
                    dims: e
                });
            default:
                throw new Error(`tensorReshape: tensor location ${t1.location} is not supported`);
        }
    };
});
var Be, Sr = V(()=>{
...
var Tr, Ja, Ve, Re, _t, wt, jn = V(()=>{
    ...
    Fn();
    Tr = (t1, e)=>{
        (typeof Oe.trace > "u" ? !Oe.wasm.trace : !Oe.trace) || console.timeStamp(`${t1}::ORT::${e}`);
    }, Ja = (t1, e)=>{
        let r = new Error().stack?.split(/\r\n|\r|\n/g) || [], n = !1;
        for(let o = 0; o < r.length; o++){
            if (n && !r[o].includes("TRACE_FUNC")) {
                let i = `FUNC_${t1}::${r[o].trim().split(" ")[1]}`;
                e && (i += `::${e}`), Tr("CPU", i);
                return;
            }
        ...
        (typeof Oe.trace > "u" ? !Oe.wasm.trace : !Oe.trace) || Ja("BEGIN", t1);
    }, Re = (t1)=>{
        (typeof Oe.trace > "u" ? !Oe.wasm.trace : !Oe.trace) || Ja("END", t1);
    }, _t = (t1)=>{
        (typeof Oe.trace > "u" ? !Oe.wasm.trace : !Oe.trace) || console.time(`ORT::${t1}`);
    }, wt = (t1)=>{
        (typeof Oe.trace > "u" ? !Oe.wasm.trace : !Oe.trace) || console.timeEnd(`ORT::${t1}`);
    };
});
var Ir, es = V(()=>{
    "use strict";
    ...
    Ir = class t1 {
        ...
        static async create(e, r, n, o) {
            ...
            return wt("InferenceSession.create"), Re(), new t1(c);
        }
        startProfiling() {
...
var ss, us, wf, ls = V(()=>{
    ...
    us && (self.onmessage = (t1)=>{
        let { type: e, in: r } = t1.data;
        try {
            switch(e){
                case "init-wasm":
                    Er(r.wasm).then(()=>{
    ...
    wf = us ? null : (t1)=>new Worker(t1 ?? We, {
            type: "module",
            name: ss
        });
});
...
async function cs(t1 = {}) {
    var e = t1, r = !!globalThis.window, n = !!globalThis.WorkerGlobalScope, o = n && self.name?.startsWith("em-pthread");
    e.mountExternalData = (a, l)=>{
        a.startsWith("./") && (a = a.substring(2)), (e.Xc || (e.Xc = new Map)).set(a, l);
...
`));
    ...
    var u, d, c = (a, l)=>{
        throw l;
    }, p = __TURBOPACK__import$2e$meta__.url, m = "";
    if (r || n) {
        try {
            m = new URL(".", p).href;
        } catch  {}
    ...
    async function be() {
        ...
        }) : o ? a(new WebAssembly.Instance(y, G()), y) : (ae ??= e.locateFile ? e.locateFile ? e.locateFile("ort-wasm-simd-threaded.jsep.wasm", m) : m + "ort-wasm-simd-threaded.jsep.wasm" : new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm (static in ecmascript, tag client)")).href, l = await async function(f) {
            var w = ae;
            if (!g && !z(w)) try {
                var C = fetch(w, {
                    credentials: "same-origin"
    ...
    function Fo() {
        var a = new Worker((()=>{
            let l = URL;
            return __TURBOPACK__import$2e$meta__.url > "file:" && __TURBOPACK__import$2e$meta__.url < "file;" ? new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort.bundle.min.mjs (static in ecmascript, tag client)")) : new URL(__TURBOPACK__import$2e$meta__.url);
        })(), {
            type: "module",
    ...
    var bt = 0, et = null, hi = 0, br = [], An = new Map, gi = new Map, bi = new Map, Vp = 0, En = null, Lp = [], yi = (a)=>(function(l) {
            if (!A) {
                if (bt === 0) {
                    var h = !1, f = !1;
                    l((w = 0)=>{
  ...
  ${B}
  }`, h = new Function(Object.keys(P), B)(...Object.values(P)), B = `methodCaller<(${w.map((H)=>H.name)}) => ${f.name}>`, Gp(Object.defineProperty(h, "name", {
            value: B
        }));
    }
    function jp(a, l) {
    ...
    function lm(a, l, h, f) {
        a >>>= 0, l >>>= 0, h >>>= 0, f >>>= 0;
        var w = new Date().getFullYear(), C = new Date(w, 0, 1).getTimezoneOffset();
...
var gs, Xn, xf, We, bs, Yn, Sf, Tf, ys, If, fs, _s, hs, ws, Ar = V(()=>{
    "use strict";
    Cr();
    gs = typeof location > "u" ? void 0 : location.origin, Xn = __TURBOPACK__import$2e$meta__.url > "file:" && __TURBOPACK__import$2e$meta__.url < "file;", xf = ()=>{
        if ("TURBOPACK compile-time truthy", 1) {
            if (Xn) {
                let t1 = URL;
                return new URL(new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort.bundle.min.mjs (static in ecmascript, tag client)")).href, gs).href;
            }
        ...
        try {
            let r = e ?? We;
            return (r ? new URL(t1, r) : new URL(t1)).origin === gs;
        } catch  {
            return !1;
        }
    }, Sf = (t1, e)=>{
        let r = e ?? We;
        try {
            return (r ? new URL(t1, r) : new URL(t1)).href;
        } catch  {
            return;
        }
    }, Tf = (t1, e)=>`${e ?? "./"}${t1}`, ys = async (t1)=>{
        let r = await (await fetch(t1, {
            credentials: "same-origin"
        })).blob();
        return URL.createObjectURL(r);
    }, If = async (t1)=>(await import(/*webpackIgnore:true*/ /*@vite-ignore*/ t1)).default, fs = (ls(), Xt(ds)).default, _s = async ()=>{
    ...
    }, hs = (ms(), Xt(ps)).default, ws = async (t1, e, r, n)=>{
        let o = hs && !(t1 || e);
        ...
        {
            let i = "ort-wasm-simd-threaded.jsep.mjs", s = t1 ?? Sf(i, e), u = !!1 && r && s && !Yn(s, e), d = u ? await ys(s) : s ?? Tf(i, e);
            return [
                u ? d : void 0,
                await If(d)
            ];
...
var Jn, eo, Rr, vs, Cf, Af, Ef, Er, ye, vt = V(()=>{
    ...
    eo = !1, Rr = !1, vs = !1, Cf = ()=>{
        ...
        Rr = !0;
        let e = t1.initTimeout, r = t1.numThreads;
        if (t1.simd !== !1) {
            if (t1.simd === "relaxed") {
        ...
        let n = Cf();
        r > 1 && !n && (typeof self < "u" && !self.crossOriginIsolated && console.warn("env.wasm.numThreads is set to " + r + ", but this will not work unless you enable crossOriginIsolated mode. See https://web.dev/cross-origin-isolation-guide/ for more info."), console.warn("WebAssembly multi-threading is not supported in the current environment. Falling back to single-threading."), t1.numThreads = r = 1);
        let o = t1.wasmPaths, i = typeof o == "string" ? o : void 0, s = o?.mjs, u = s?.href ?? s, d = o?.wasm, c = d?.href ?? d, p = t1.wasmBinary, [m, g] = await ws(u, i, r > 1, !!p || !!c), y = !1, b = [];
...
var Ge, tr, me, Ur = V(()=>{
    ...
    vt();
    Ge = (t1, e)=>{
        let r = ye(), n = r.lengthBytesUTF8(t1) + 1, o = r._malloc(n);
        return r.stringToUTF8(t1, o, n), e.push(o), o;
    }, tr = (t1, e, r, n)=>{
        if (typeof t1 == "object" && t1 !== null) {
            if (r.has(t1)) throw new Error("Circular reference in options");
            r.add(t1);
        }
        Object.entries(t1).forEach(([o, i])=>{
            let s = e ? e + o : o;
        ...
        try {
            ...
            throw new Error(`${t1} ERROR_CODE: ${i}, ERROR_MESSAGE: ${u}`);
        } finally{
            e.stackRestore(r);
        }
    };
...
var $s, xs = V(()=>{
    ...
    $s = (t1)=>{
        let e = ye(), r = 0, n = [], o = t1 || {};
        try {
            if (t1?.logSeverityLevel === void 0) o.logSeverityLevel = 2;
            else if (typeof t1.logSeverityLevel != "number" || !Number.isInteger(t1.logSeverityLevel) || t1.logSeverityLevel < 0 || t1.logSeverityLevel > 4) throw new Error(`log severity level is not valid: ${t1.logSeverityLevel}`);
            if (t1?.logVerbosityLevel === void 0) o.logVerbosityLevel = 0;
            else if (typeof t1.logVerbosityLevel != "number" || !Number.isInteger(t1.logVerbosityLevel)) throw new Error(`log verbosity level is not valid: ${t1.logVerbosityLevel}`);
            t1?.terminate === void 0 && (o.terminate = !1);
            let i = 0;
            return t1?.tag !== void 0 && (i = Ge(t1.tag, n)), r = e._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && me("Can't create run options."), t1?.extra !== void 0 && tr(t1.extra, "", new WeakSet, (s, u)=>{
    ...
    kf = (t1)=>{
        switch(t1){
            ...
            case "all":
                return 99;
            default:
                throw new Error(`unsupported graph optimization level: ${t1}`);
        }
    }, Pf = (t1)=>{
        switch(t1){
            case "sequential":
            ...
            case "parallel":
                return 1;
            default:
                throw new Error(`unsupported execution mode: ${t1}`);
        }
    }, Of = (t1)=>{
        t1.extra || (t1.extra = {}), t1.extra.session || (t1.extra.session = {});
        let e = t1.extra.session;
        e.use_ort_model_bytes_directly || (e.use_ort_model_bytes_directly = "1"), t1.executionProviders && t1.executionProviders.some((r)=>(typeof r == "string" ? r : r.name) === "webgpu") && (t1.enableMemPattern = !1);
    }, Lt = (t1, e, r, n)=>{
        let o = Ge(e, n), i = Ge(r, n);
        ye()._OrtAddSessionConfigEntry(t1, o, i) !== 0 && me(`Can't set a session config entry: ${e} - ${r}.`);
    }, zf = async (t1, e, r)=>{
        ...
        for (let o of n){
            ...
            switch(i){
                case "webnn":
                    if (i = "WEBNN", Lt(t1, "session.disable_quant_qdq", "1", r), Lt(t1, "session.disable_qdq_constant_folding", "1", r), typeof o != "string") {
                        let g = o?.deviceType;
                        g && Lt(t1, "deviceType", g, r);
                    }
                    break;
                case "webgpu":
                    if (i = "JS", typeof o != "string") {
                        ...
                        if (m?.preferredLayout) {
                            ...
                            Lt(t1, "preferredLayout", m.preferredLayout, r);
                        }
                    }
                    break;
                case "wasm":
            ...
            await ye()._OrtAppendExecutionProvider(t1, u, c, p, d) !== 0 && me(`Can't append execution provider: ${i}.`);
        }
    }, Ss = async (t1)=>{
        let e = ye(), r = 0, n = [], o = t1 || {};
        Of(o);
        try {
            ...
            return o.extra !== void 0 && tr(o.extra, "", new WeakSet, (m, g)=>{
                Lt(r, m, g, n);
            }), [
                r,
                n
    ...
    $t = (t1)=>{
        switch(t1){
            ...
            case "uint4":
                return 21;
            default:
                throw new Error(`unsupported data type: ${t1}`);
        }
    }, rt = (t1)=>{
        switch(t1){
            case 3:
        ...
        let r = [
            ...
            .5,
            .5
        ][t1], n = typeof e == "number" ? e : e.reduce((o, i)=>o * i, 1);
        ...
        switch(t1){
            ...
            case "fatal":
                return 4;
            default:
                throw new Error(`unsupported logging level: ${t1}`);
        }
    }, Nr = (t1)=>t1 === "float32" || t1 === "float16" || t1 === "int32" || t1 === "int64" || t1 === "uint32" || t1 === "uint8" || t1 === "bool" || t1 === "uint4" || t1 === "int4", Vr = (t1)=>t1 === "float32" || t1 === "float16" || t1 === "int32" || t1 === "int64" || t1 === "uint32" || t1 === "uint64" || t1 === "int8" || t1 === "uint8" || t1 === "bool" || t1 === "uint4" || t1 === "int4", to = (t1)=>{
        switch(t1){
            case "none":
                return 0;
            case "cpu":
            ...
            case "ml-tensor":
                return 5;
            default:
                throw new Error(`unsupported data location: ${t1}`);
        }
    };
});
var nr, ro = V(()=>{
    ...
    Cr();
    nr = async (t1)=>{
        if (typeof t1 == "string") if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        else {
            let e = await fetch(t1);
            if (!e.ok) throw new Error(`failed to load external data file: ${t1}`);
            let r = e.headers.get("Content-Length"), n = r ? parseInt(r, 10) : 0;
            if (n < 1073741824) return new Uint8Array(await e.arrayBuffer());
            {
                if (!e.body) throw new Error(`failed to load external data file: ${t1}, no response body.`);
        ...
        else return t1 instanceof Blob ? new Uint8Array(await t1.arrayBuffer()) : t1 instanceof Uint8Array ? t1 : new Uint8Array(t1);
    };
});
var Df, Bf, Is, Cs, Lr, Mf, ie, nt = V(()=>{
    ...
    Df = [
        ...
        console.log(`[${Df[t1]},${new Date().toISOString()}]${e}`);
    }, Lr = (t1, e)=>{
        Is = t1, Cs = e;
    }, Mf = (t1, e)=>{
        let r = rr(t1), n = rr(Is);
...
var no, ot, k, zt, Wr, As, Es, re = V(()=>{
    ...
    no = class {
        ...
        static size(e) {
            return t1.getSizeFromDimensionRange(e, 0, e.length);
        }
        ...
        static sizeFromDimension(e, r) {
            ...
            return t1.getSizeFromDimensionRange(e, r, e.length);
        }
        static sizeToDimension(e, r) {
            ...
            return t1.getSizeFromDimensionRange(e, 0, r);
        }
        ...
        static adjustPadsBasedOnAutoPad(e, r, n, o, i, s, u) {
            if (u) {
                ...
                for(let d = 0; d < e.length - 2; d++)t1.adjustPadAndReturnShape(e[d + (s ? 1 : 2)], r[d], n[d], o[d], i, d, d + e.length - 2, u);
            }
        }
        static computePoolOutputShape(e, r, n, o, i, s, u) {
            ...
            return t1.computeShapeHelper(e, r, d, n, o, i, s, u), d;
        }
        static computeConvOutputShape(e, r, n, o, i, s, u) {
            ...
            return t1.computeShapeHelper(!1, e, d, n, o, i, s, u), d;
        }
        static computeShapeHelper(e, r, n, o, i, s, u, d) {
            if (e) for(let c = 0; c < r.length - 2; c++)n.push(1);
            else for(let c = 0; c < r.length - 2; c++)n.push(t1.adjustPadAndReturnShape(r[c + 2], o[c], i[c], s[c], u, c, c + r.length - 2, d));
        }
...
var Ps, ao, Os, Rf, ks, Uf, zs, Hr, Fr, io, Ds, Bs = V(()=>{
    ...
    Ps = new Map([
        ...
        if (e === "int32") return t1;
        let r = Ps.get(e);
        if (!r) throw new Error(`WebNN backend does not support data type: ${e}`);
        let n = r / 8;
        if (t1.byteLength % n !== 0) throw new Error(`Invalid Uint8Array length - must be a multiple of ${n}.`);
        let o = t1.byteLength / n, i = new (Wt(e))(t1.buffer, t1.byteOffset, o);
        switch(e){
            case "int64":
            case "uint64":
                {
        ...
        if (e === "int32") return t1;
        if (t1.byteLength % 4 !== 0) throw new Error("Invalid Uint8Array length - must be a multiple of 4 (int32).");
        let r = t1.byteLength / 4, n = new Int32Array(t1.buffer, t1.byteOffset, r);
        switch(e){
            case "int64":
                {
        ...
        let r = Ps.get(t1);
        if (!r) throw new Error(`WebNN backend does not support data type: ${t1}`);
...
var qr, Nf, Kr, Ms = V(()=>{
    ...
    qr = new Map([
        ...
        if (t1 === e) return !0;
        if (t1 === void 0 || e === void 0) return !1;
        let r = Object.keys(t1).sort(), n = Object.keys(e).sort();
        return r.length === n.length && r.every((o, i)=>o === n[i] && t1[o] === e[o]);
    }, Kr = class {
        constructor(e){
...
var Rs, so, uo, Vf, Lf, Us, co, lo, Vs, Ls = V(()=>{
    ...
    Rs = new Map([
    ...
    ]), so = [], uo = (t1)=>Math.ceil(Number(t1) / 16) * 16, Vf = (t1)=>{
        for(let e = 0; e < so.length; e++){
            let r = so[e];
            if (t1 <= r) return r;
        }
        return Math.ceil(t1 / 16) * 16;
    }, Lf = 1, Us = ()=>Lf++, co = async (t1, e, r, n)=>{
        let o = uo(r), i = t1.device.createBuffer({
            size: o,
            usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ
        });
        try {
            let s = t1.getCommandEncoder();
            t1.endComputePass(), s.copyBufferToBuffer(e, 0, i, 0, o), t1.flush(), await i.mapAsync(GPUMapMode.READ);
        ...
        upload(e, r) {
            ...
            p.copyBufferToBuffer(d, 0, u.gpuData.buffer, 0, s), this.backend.device.queue.submit([
                p.finish()
            ]), d.destroy(), ie("verbose", ()=>`[WebGPU] GpuDataManager.upload(id=${e})`);
        }
        memcpy(e, r) {
...
var Dt, fo, we, ze, W, fe, ho, Bt, Ze, j, Zr, O, U, Ws, Qr, mo, Gs, oe = V(()=>{
    ...
    Dt = 64, fo = (t1, e)=>{
        ...
        switch(Number(t1)){
            ...
            case 21:
                return "u32";
            default:
                throw new Error(`Unknown data type: ${t1}`);
        }
    }, we = (t1, e = 1)=>{
        let r = fo(t1, e);
    ...
    }, fe = (t1)=>t1 % 4 === 0 ? 4 : t1 % 2 === 0 ? 2 : 1, ho = (t1 = "f32", e, r = "0")=>!e || e === 1 ? `${t1}(${r})` : `vec${e}<${t1}>(${r})`, Bt = (t1, e, r)=>t1 === "f32" ? r : e === 1 ? `f32(${r})` : `vec${e}<f32>(${r})`, Ze = (t1, e)=>e === 4 ? `(${t1}.x + ${t1}.y + ${t1}.z + ${t1}.w)` : e === 2 ? `(${t1}.x + ${t1}.y)` : e === 3 ? `(${t1}.x + ${t1}.y + ${t1}.z)` : t1, j = (t1, e, r, n)=>t1.startsWith("uniforms.") && r > 4 ? typeof e == "string" ? n === "f16" ? `${t1}[(${e}) / 8][(${e}) % 8 / 4][(${e}) % 8 % 4]` : `${t1}[(${e}) / 4][(${e}) % 4]` : n === "f16" ? `${t1}[${Math.floor(e / 8)}][${Math.floor(e % 8 / 4)}][${e % 8 % 4}]` : `${t1}[${Math.floor(e / 4)}][${e % 4}]` : r > 1 ? `${t1}[${e}]` : t1, Zr = (t1, e, r, n, o)=>{
        let i = typeof r == "number", s = i ? r : r.length, u = [
            ...
            get: !1,
            getByIndices: !1
        }, _ = i ? "uniforms." : "", T = `${_}${t1}_shape`, x = `${_}${t1}_strides`, $ = "";
        for(let M = 0; M < s - 1; M++)$ += `
    ...
    `;
        $ += `indices[${s - 1}] = current;`;
        let S = s < 2 ? "" : `
  fn o2i_${t1}(offset: u32) -> ${g.indices} {
    var indices: ${g.indices};
    var current = offset;
    ${$}
    return indices;
  }`, I = (M)=>(b.offsetToIndices = !0, s < 2 ? M : `o2i_${t1}(${M})`), E = [];
        if (s >= 2) for(let M = s - 1; M >= 0; M--)E.push(`${j(x, M, s)} * (indices[${M}])`);
        let A = s < 2 ? "" : `
  fn i2o_${t1}(indices: ${g.indices}) -> u32 {
    return ${E.join("+")};
  }`, z = (M)=>(b.indicesToOffset = !0, s < 2 ? M : `i2o_${t1}(${M})`), v = (...M)=>s === 0 ? "0u" : `${g.indices}(${M.map(y).join(",")})`, R = (M, G)=>s < 2 ? `${M}` : `${j(M, G, s)}`, N = (M, G, be)=>s < 2 ? `${M}=${be};` : `${j(M, G, s)}=${be};`, F = {}, q = (M, G)=>{
            b.broadcastedIndicesToOffset = !0;
            let be = `${G.name}broadcastedIndicesTo${t1}Offset`;
            ...
            return F[be] = `fn ${be}(outputIndices: ${G.type.indices}) -> u32 {
             return ${Ee.length > 0 ? Ee.join("+") : "0u"};
                ...
                if (g.storage === g.value) return `${t1}[${M}]=${G};`;
                if (g.storage === "vec2<u32>" && g.value === "i32") return `${t1}[${M}]=vec2<u32>(u32(${G}), select(0u, 0xFFFFFFFFu, ${G} < 0));`;
                if (g.storage === "vec2<u32>" && g.value === "u32") return `${t1}[${M}]=vec2<u32>(u32(${G}), 0u);`;
                if (g.storage === "u32" && g.value === "vec4<bool>") return `${t1}[${M}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${G}));`;
                throw new Error(`not supported combination of storage type ${g.storage} and value type ${g.value} yet`);
            })(), D = (M)=>(()=>{
                if (g.storage === g.value) return `${t1}[${M}]`;
                if (g.storage === "vec2<u32>" && g.value === "i32") return `i32(${t1}[${M}].x)`;
                if (g.storage === "vec2<u32>" && g.value === "u32") return `u32(${t1}[${M}].x)`;
                if (g.storage === "u32" && g.value === "vec4<bool>") return `vec4<bool>(bool(${t1}[${M}] & 0xFFu), bool(${t1}[${M}] & 0xFF00u), bool(${t1}[${M}] & 0xFF0000u), bool(${t1}[${M}] & 0xFF000000u))`;
                throw new Error(`not supported combination of storage type ${g.storage} and value type ${g.value} yet`);
            })(), L = s < 2 ? "" : `
  fn get_${t1}ByIndices(indices: ${g.indices}) -> ${p} {
    return ${D(`i2o_${t1}(indices)`)};
  }`, Q = s < 2 ? "" : (()=>{
            let M = u.map((be)=>`d${be}: u32`).join(", "), G = u.map((be)=>`d${be}`).join(", ");
            return `
  fn get_${t1}(${M}) -> ${p} {
    return get_${t1}ByIndices(${v(G)});
  }`;
        })(), Y = (...M)=>{
            if (M.length !== s) throw new Error(`indices length must be ${s}`);
            let G = M.map(y).join(",");
            return s === 0 ? D("0u") : s === 1 ? D(G[0]) : (b.get = !0, b.getByIndices = !0, b.indicesToOffset = !0, `get_${t1}(${G})`);
        }, Z = (M)=>s < 2 ? D(M) : (b.getByIndices = !0, b.indicesToOffset = !0, `get_${t1}ByIndices(${M})`), te = s < 2 ? "" : `
  fn set_${t1}ByIndices(indices: ${g.indices}, value: ${p}) {
    ${X(`i2o_${t1}(indices)`, "value")}
  }`, ae = s < 2 ? "" : (()=>{
            let M = u.map((be)=>`d${be}: u32`).join(", "), G = u.map((be)=>`d${be}`).join(", ");
            return `
  fn set_${t1}(${M}, value: ${p}) {
    set_${t1}ByIndices(${v(G)}, value);
  }`;
        })();
        return {
            impl: ()=>{
...
`);
            ...
            set: (...M)=>{
                ...
                return s === 0 ? X("0u", G) : s === 1 ? X(be[0], G) : (b.set = !0, b.setByIndices = !0, b.indicesToOffset = !0, `set_${t1}(${be}, ${G})`);
            },
            setByOffset: X,
            setByIndices: (M, G)=>s < 2 ? X(M, G) : (b.setByIndices = !0, b.indicesToOffset = !0, `set_${t1}ByIndices(${M}, ${G});`),
            get: Y,
            getByOffset: D,
            getByIndices: Z,
            usage: n,
    ...
    }, O = (t1, e, r, n = 1)=>Zr(t1, e, r, "input", n), U = (t1, e, r, n = 1)=>Zr(t1, e, r, "output", n), Ws = (t1, e, r)=>Zr(t1, e, r, "atomicOutput", 1), Qr = (t1, e, r, n = 1)=>Zr(t1, e, r, "internal", n), mo = class {
        constructor(e, r){
...
var Wf, Hs, Gf, Hf, Ff, qf, De, Fs, qs, pt = V(()=>{
    ...
    oe();
    Wf = (t1, e)=>{
        if (!t1 || t1.length !== 1) throw new Error("Transpose requires 1 input.");
        if (e.length !== 0 && e.length !== t1[0].dims.length) throw new Error(`perm size ${e.length} does not match input rank ${t1[0].dims.length}`);
    }, Hs = (t1, e)=>e.length !== 0 ? e : [
            ...new Array(t1).keys()
        ].reverse(), Gf = (t1, e)=>k.sortBasedOnPerm(t1, Hs(t1.length, e)), Hf = (t1, e, r, n)=>{
        let o = `fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;
        for(let i = 0; i < e; ++i)o += `a[${t1[i]}]=i[${i}];`;
        return o += "return a;}";
    }, Ff = (t1, e)=>{
        let r = [], n = [];
        for(let o = 0; o < t1.length; ++o)t1[o] !== 1 && r.push(t1[o]), t1[e[o]] !== 1 && n.push(e[o]);
        return {
            newShape: r,
            newPerm: n
        };
        ...
        let r = 0;
        for(let n = 0; n < t1.length; ++n)if (e[t1[n]] !== 1) {
            if (t1[n] < r) return !1;
            r = t1[n];
        }
        return !0;
    }, De = (t1, e)=>{
        let r = t1.dataType, n = t1.dims.length, o = Hs(n, e), i = Gf(t1.dims, o), s = t1.dims, u = i, d = n < 2 || qf(o, t1.dims), c;
        if (d) return c = (_)=>{
  ...
  ${_.mainStart()}
    ...
    output[global_idx] = input[global_idx];
        ...
        let { newShape: p, newPerm: m } = Ff(t1.dims, o), g = k.areEqual(m, [
            2,
            3,
            1
        ]), y = k.areEqual(m, [
  ...
  ${_.mainStart()}
    ...
    ${x.setByOffset("global_idx", T.getByIndices("aIndices"))}
        ...
        Wf(t1.inputs, e.perm), t1.compute(De(t1.inputs[0], e.perm));
    }, qs = (t1)=>ee({
            perm: t1.perm
        });
});
var Kf, jf, Zf, Qf, Yf, Xf, Jf, eh, th, rh, it, Ks, js, Zs, Qs, Ys, Xs, Js, eu, tu, ru, nu = V(()=>{
    ...
    Kf = {
        ...
        let r = [];
        for(let n = e - t1; n < e; ++n)r.push(n);
        return r;
    }, Xf = (t1, e)=>{
        let r = [], n = t1.length;
        for(let i = 0; i < n; i++)e.indexOf(i) === -1 && r.push(t1[i]);
        let o = e.map((i)=>t1[i]);
        return [
            r,
            o
        ...
        let r = t1.length + e.length, n = [], o = 0;
        for(let i = 0; i < r; i++)e.indexOf(i) === -1 ? n.push(t1[o++]) : n.push(1);
        return n;
    }, eh = (t1, e)=>{
        for(let r = 0; r < t1.length; ++r)if (t1[t1.length - r - 1] !== e - 1 - r) return !1;
        return !0;
    }, th = (t1, e)=>{
        let r = [];
        if (!eh(t1, e)) {
            for(let n = 0; n < e; ++n)t1.indexOf(n) === -1 && r.push(n);
            t1.forEach((n)=>r.push(n));
        }
        return r;
    }, rh = (t1, e, r, n, o, i, s)=>{
       ...
       `, b = (_)=>`
        ...
        let o = t1.inputs.length === 1 ? r : go(t1.inputs, r), i = o.axes;
        i.length === 0 && !o.noopWithEmptyAxes && (i = t1.inputs[0].dims.map((y, b)=>b));
        let s = k.normalizeAxes(i, t1.inputs[0].dims.length), u = s, d = t1.inputs[0], c = th(u, t1.inputs[0].dims.length);
        c.length > 0 && (d = t1.compute(De(t1.inputs[0], c), {
            inputs: [
                0
            ],
            outputs: [
        ...
        o.keepDims && (g = Jf(p, s)), t1.compute(rh(e, o.cacheKey, [
            d
        ], n, t1.inputs[0].dataType, g, m), {
            inputs: [
                d
            ]
        });
    }, Ks = (t1, e)=>{
        it(t1, "ReduceMeanShared", e, "mean");
    }, js = (t1, e)=>{
        it(t1, "ReduceL1Shared", e, "l1");
    }, Zs = (t1, e)=>{
        it(t1, "ReduceL2Shared", e, "l2");
    }, Qs = (t1, e)=>{
        it(t1, "ReduceLogSumExpShared", e, "logSumExp");
    }, Ys = (t1, e)=>{
        it(t1, "ReduceMaxShared", e, "max");
    }, Xs = (t1, e)=>{
        it(t1, "ReduceMinShared", e, "min");
    }, Js = (t1, e)=>{
        it(t1, "ReduceProdShared", e, "prod");
    }, eu = (t1, e)=>{
        it(t1, "ReduceSumShared", e, "sum");
    }, tu = (t1, e)=>{
        it(t1, "ReduceSumSquareShared", e, "sumSquare");
    }, ru = (t1, e)=>{
        it(t1, "ReduceLogSumShared", e, "logSum");
    };
});
var at, nh, Xr, go, st, oh, ih, ah, sh, uh, dh, lh, ch, ph, mh, ut, ou, iu, au, su, uu, du, lu, cu, pu, mu, Yr = V(()=>{
    ...
    nu();
    at = (t1)=>{
        if (!t1 || t1.length === 0 || t1.length > 2) throw new Error("Reduce op requires 1 or 2 inputs.");
        if (t1.length === 2 && t1[1].dims.length !== 1) throw new Error("Invalid axes input dims.");
    }, nh = (t1)=>[
            "",
            "",
            `var value = ${t1.getByIndices("input_indices")};`,
            ""
        ], Xr = (t1, e, r, n, o, i, s = !1, u = !1)=>{
...
`)}
        ...
        let r = [];
        return t1[1].dims[0] > 0 && t1[1].getBigInt64Array().forEach((n)=>r.push(Number(n))), ee({
            axes: r,
            keepDims: e.keepDims,
            noopWithEmptyAxes: e.noopWithEmptyAxes
        });
    }, st = (t1, e, r, n)=>{
        let o = t1.inputs, i = o.length === 1 ? r : go(o, r);
        t1.compute(Xr(e, {
            hint: i.cacheKey,
            inputDependencies: [
                "rank"
            ...
            o[0]
        ], i.noopWithEmptyAxes && i.axes.length === 0 ? nh : n, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), {
            inputs: [
                0
            ]
        });
    }, oh = (t1, e)=>{
        at(t1.inputs), st(t1, "ReduceLogSum", e, (n, o)=>[
        ...
        at(t1.inputs), st(t1, "ReduceL1", e, (n, o)=>[
                `var value = ${o.type.storage}(0);`,
                "",
        ...
        at(t1.inputs), st(t1, "ReduceL2", e, (n, o)=>[
        ...
        at(t1.inputs), st(t1, "ReduceLogSumExp", e, (n, o)=>[
                `var value = ${o.type.storage}(0);`,
                "",
        ...
        at(t1.inputs), st(t1, "ReduceMax", e, (n, o, i)=>{
            let s = [];
...
`)}`,
        ...
        at(t1.inputs), st(t1, "ReduceMean", e, (n, o, i)=>{
            let s = 1;
            for(let u = 0; u < n.rank; u++)(i.indexOf(u) >= 0 || i.length === 0) && (s *= t1.inputs[0].dims[u]);
            return [
                "var sum = f32(0);",
                "",
        ...
        at(t1.inputs), st(t1, "ReduceMin", e, (n, o, i)=>{
            let s = [];
...
`)}`,
        ...
        at(t1.inputs), st(t1, "ReduceProd", e, (n, o)=>[
        ...
        at(t1.inputs), st(t1, "ReduceSum", e, (n, o)=>[
                `var value = ${o.type.storage}(0);`,
                "",
                `value += ${n.getByIndices("input_indices")};`,
                ""
        ...
        at(t1.inputs), st(t1, "ReduceSumSquare", e, (n, o)=>[
                `var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,
                "",
                `t = ${n.getByIndices("input_indices")}; value += t * t;`,
                ""
        ...
        let n = 1, o = 1;
        for(let i = 0; i < e.length; i++)e.indexOf(i) === -1 ? n *= t1[i] : o *= t1[i];
        return o < 32 && n > 1024;
    }, ou = (t1, e)=>{
        ut(t1.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? dh(t1, e) : Ks(t1, e);
    }, iu = (t1, e)=>{
        ut(t1.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? ih(t1, e) : js(t1, e);
    }, au = (t1, e)=>{
        ut(t1.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? ah(t1, e) : Zs(t1, e);
    }, su = (t1, e)=>{
        ut(t1.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? sh(t1, e) : Qs(t1, e);
    }, uu = (t1, e)=>{
        ut(t1.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? uh(t1, e) : Ys(t1, e);
    }, du = (t1, e)=>{
        ut(t1.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? lh(t1, e) : Xs(t1, e);
    }, lu = (t1, e)=>{
        ut(t1.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? ch(t1, e) : Js(t1, e);
    }, cu = (t1, e)=>{
        ut(t1.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? ph(t1, e) : eu(t1, e);
    }, pu = (t1, e)=>{
        ut(t1.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? mh(t1, e) : tu(t1, e);
    }, mu = (t1, e)=>{
        ut(t1.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? oh(t1, e) : ru(t1, e);
    };
});
var fu, hu, gu, bo, bu = V(()=>{
    ...
    Yr();
    fu = (t1)=>{
        if (!t1 || t1.length === 0 || t1.length > 2) throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");
        if (t1[0].dataType !== 1) throw new Error("Invalid input type.");
    }, hu = (t1, e)=>{
        fu(t1.inputs);
        let r = (n, o, i)=>{
            let s = [];
...
var fh, yo, hh, gh, bh, Gt, yh, yu, Jr = V(()=>{
    ...
    oe();
    fh = (t1, e)=>{
        let r = t1[0], n = t1[1], o = t1[2], i = t1[3], s = t1[4], u = t1[5];
      ...
      total_sequence_length = u32(${t1?.getByOffset("batchIdx")}) + 1;
  ...
  ${x.mainStart([
    ...
    if (sum == 0) {
      ...
      ${s ? `
    ...
    }, gh = (t1, e, r, n, o, i, s, u, d)=>{
        let c = s + i.kvSequenceLength, p = [
            i.batchSize,
            i.numHeads,
            i.sequenceLength,
            c
        ], m = t1 > 1 && n, g = i.kvNumHeads ? i.kvNumHeads : i.numHeads, y = m ? [
            i.batchSize,
            g,
            c,
            i.headSize
        ...
        let v = (R)=>{
            let N = O("q", e.dataType, e.dims, T), F = O("key", r.dataType, r.dims, T), q = [
                N,
                F
            ];
            if (E) {
  ...
  ${R.mainStart([
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(()=>{
    ...
    }, bh = (t1, e, r, n, o, i, s = void 0, u = void 0)=>{
        let d = i + o.kvSequenceLength, c = o.nReps ? o.nReps : 1, p = o.vHiddenSize * c, m = t1 > 1 && n, g = o.kvNumHeads ? o.kvNumHeads : o.numHeads, y = m ? [
            o.batchSize,
            g,
            d,
            o.headSize
        ...
        let E = (A)=>{
            let z = O("probs", e.dataType, e.dims), v = O("v", r.dataType, r.dims), R = [
                z,
                v
            ];
  ...
  ${A.mainStart([
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
    ...
    }, Gt = (t1, e, r, n, o, i, s, u, d, c, p = void 0, m = void 0)=>{
        let g = Math.min(t1.outputCount, 1 + (s ? 1 : 0) + (u ? 1 : 0)), y = g > 1 ? s : void 0, b = g > 1 ? u : void 0, _ = g > 1 ? c.pastSequenceLength : 0, T = _ + c.kvSequenceLength, x = d && k.size(d.dims) > 0 ? d : void 0, $ = [
            e,
            r
        ];
        y && k.size(y.dims) > 0 && $.push(y), x && $.push(x), p && $.push(p), m && $.push(m);
        let S = t1.compute(gh(g, e, r, y, x, c, _, p, m), {
            inputs: $,
            outputs: g > 1 ? [
                -1,
                1
        ...
        t1.compute(hh(S, c.batchSize, c.numHeads, _, c.sequenceLength, T, p, m), {
            inputs: p && m ? [
                S,
                p,
                m
        ...
        b && k.size(b.dims) > 0 && I.push(b), p && I.push(p), m && I.push(m), t1.compute(bh(g, S, n, b, c, _, p, m), {
            inputs: I,
            outputs: g > 1 ? [
                0,
                2
        ...
        let r = [
            ...
            let g = U("output_q", d[0].dataType, r), y = U("output_k", d[0].dataType, r), b = U("output_v", d[0].dataType, r), _ = O("input", d[0].dataType, d[0].dims), T = O("weight", d[1].dataType, d[1].dims), x = O("bias", d[2].dataType, d[2].dims), $ = _.type.storage, S = [
                {
                    name: "M",
                    type: "u32"
                },
  ...
  ${m.mainStart([
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      output_v[outputIdx] = valueV;
        ...
        let r = fh(t1.inputs, e), [n, o, i] = yh(t1, r);
        return Gt(t1, n, o, i, t1.inputs[4], void 0, void 0, void 0, t1.inputs[5], r);
    };
});
var _h, wh, vh, _u, wu = V(()=>{
    ...
    oe();
    _h = (t1, e)=>{
        if (!t1 || t1.length !== 5) throw new Error("BatchNormalization requires 5 inputs");
        let r = (n, o, i)=>{
            let s = o.length;
        ...
        if (t1[0].dims.length > 1) {
            let n = e.format === "NHWC" ? e.spatial ? t1[0].dims.slice(-1) : t1[0].dims.slice(-1).concat(t1[0].dims.slice(1, t1[0].dims.length - 1)) : t1[0].dims.slice(1, e.spatial ? 2 : void 0);
            r(t1[1].dims, n, "Invalid input scale"), r(t1[2].dims, n, "Invalid input B"), r(t1[3].dims, n, "Invalid input mean"), r(t1[4].dims, n, "Invalid input var");
        } else r(t1[1].dims, [
            1
        ], "Invalid input scale"), r(t1[2].dims, [
            1
        ], "Invalid input B"), r(t1[3].dims, [
            1
        ], "Invalid input mean"), r(t1[4].dims, [
            1
        ], "Invalid input var");
    }, wh = (t1, e)=>{
        let { epsilon: r, spatial: n, format: o } = e, i = t1[0].dims, s = n ? fe(i[i.length - 1]) : 1, u = o === "NHWC" && i.length > 1 ? s : 1, d = k.size(i) / s, c = n, p = c ? i.length : i, m = O("x", t1[0].dataType, t1[0].dims, s), g = O("scale", t1[1].dataType, t1[1].dims, u), y = O("bias", t1[2].dataType, t1[2].dims, u), b = O("inputMean", t1[3].dataType, t1[3].dims, u), _ = O("inputVar", t1[4].dataType, t1[4].dims, u), T = U("y", t1[0].dataType, p, s), x = ()=>{
            let S = "";
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    ${T.setByOffset("global_idx", "value")}
        ...
        let { inputs: r, outputCount: n } = t1, o = vh({
            ...e,
            outputCount: n
        });
...
var $h, xh, vu, $u = V(()=>{
    ...
    oe();
    $h = (t1)=>{
        if (t1[0].dims.length !== 3) throw new Error("input should have 3 dimensions");
        if (![
            320,
            640,
            1280
        ].includes(t1[0].dims[2])) throw new Error("number of channels should be 320, 640 or 1280");
        if (t1[1].dims.length !== 1) throw new Error("bias is expected to have 1 dimensions");
        if (t1[0].dims[2] !== t1[1].dims[0]) throw new Error("last dimension of input and bias are not the same");
    }, xh = (t1)=>{
        let e = t1[0].dims, r = t1[0].dims[2], n = k.size(e) / 4, o = t1[0].dataType, i = O("input", o, e, 4), s = O("bias", o, [
            r
        ], 4), u = O("residual", o, e, 4), d = U("output", o, e, 4);
        return {
            name: "BiasAdd",
            getRunData: ()=>({
                    outputs: [
  ...
  ${p.mainStart()}
    ...
    ${d.setByOffset("global_idx", "value")}
        ...
        $h(t1.inputs), t1.compute(xh(t1.inputs));
    };
});
var Sh, ge, xu, Su, Tu, Iu, Cu, Au, Eu, ku, Pu, Th, Ou, zu, Du, Bu, or, Mu, en, Ru, Uu, Nu, Vu, Lu, Wu, Gu, Hu, Fu, qu, Ku, ju, Zu, Qu, Yu, Xu, Ju, ed, _o, wo, td, rd, nd, Ih, Ch, od, tn = V(()=>{
    ...
    Sh = (t1, e, r, n, o, i, s)=>{
        ...
        return s && m.push(...s), `
      ${t1.registerUniforms(m).declareVariables(c, p)}

  ${i ?? ""}

  ${t1.mainStart()}
    ${t1.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}

    let a = ${c.getByOffset("global_idx")};
    ${p.setByOffset("global_idx", d)}
  }`;
    }, ge = (t1, e, r, n, o, i = t1.dataType, s, u)=>{
        let d = [
            {
                type: 12,
                data: Math.ceil(k.size(t1.dims) / 4)
            }
        ];
        return s && d.push(...s), {
            name: e,
            ...
            getShaderSource: (c)=>Sh(c, k.size(t1.dims), t1.dataType, i, r, n, u),
            getRunData: (c)=>({
                    outputs: [
                        {
                            dims: t1.dims,
        ...
        t1.compute(ge(t1.inputs[0], "Abs", "abs"));
    }, Su = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Acos", "acos"));
    }, Tu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Acosh", "acosh"));
    }, Iu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Asin", "asin"));
    }, Cu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Asinh", "asinh"));
    }, Au = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Atan", "atan"));
    }, Eu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Atanh", "atanh"));
    }, ku = (t1)=>ee(t1), Pu = (t1, e)=>{
        let r;
        switch(e.to){
            case 10:
        ...
        t1.compute(ge(t1.inputs[0], "Cast", r, void 0, e.cacheKey, e.to));
    }, Th = (t1)=>{
        let e, r, n = t1.length >= 2 && t1[1].data !== 0, o = t1.length >= 3 && t1[2].data !== 0;
        switch(t1[0].dataType){
            case 1:
                e = n ? t1[1].getFloat32Array()[0] : -34028234663852886e22, r = o ? t1[2].getFloat32Array()[0] : 34028234663852886e22;
                break;
            case 10:
                e = n ? t1[1].getUint16Array()[0] : 64511, r = o ? t1[2].getUint16Array()[0] : 31743;
                break;
            default:
        ...
        let r = e || Th(t1.inputs), n = ze(t1.inputs[0].dataType);
        t1.compute(ge(t1.inputs[0], "Clip", (o)=>`clamp(${o}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`, void 0, r.cacheKey, void 0, [
            {
                type: t1.inputs[0].dataType,
                data: r.min
            },
            {
                type: t1.inputs[0].dataType,
        ...
        t1.compute(ge(t1.inputs[0], "Ceil", "ceil"));
    }, Du = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Cos", "cos"));
    }, Bu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Cosh", "cosh"));
    }, or = (t1)=>ee(t1), Mu = (t1, e)=>{
        let r = ze(t1.inputs[0].dataType);
        t1.compute(ge(t1.inputs[0], "Elu", (n)=>`elu_vf32(${n})`, `
...
const r0: ${t1} = 0.3275911;
const r1: ${t1} = 0.254829592;
const r2: ${t1} = -0.284496736;
const r3: ${t1} = 1.421413741;
const r4: ${t1} = -1.453152027;
const r5: ${t1} = 1.061405429;

fn erf_vf32(v: vec4<${t1}>) -> vec4<${t1}> {
  let absv = abs(v);
  let x = 1.0 / (1.0 + r0 * absv);
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
}`, Ru = (t1)=>{
        let e = ze(t1.inputs[0].dataType);
        t1.compute(ge(t1.inputs[0], "Erf", (r)=>`erf_vf32(${r})`, en(e)));
    }, Uu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Exp", "exp"));
    }, Nu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Floor", "floor"));
    }, Vu = (t1)=>{
        let e = ze(t1.inputs[0].dataType);
        t1.compute(ge(t1.inputs[0], "Gelu", (r)=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`, en(e)));
    }, Lu = (t1, e)=>{
        let r = ze(t1.inputs[0].dataType);
        t1.compute(ge(t1.inputs[0], "LeakyRelu", (n)=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`, `const leaky_relu_alpha_ = ${r}(${e.alpha});`, e.cacheKey));
    }, Wu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Not", (e)=>`!${e}`));
    }, Gu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Neg", (e)=>`-${e}`));
    }, Hu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Reciprocal", (e)=>`1.0/${e}`));
    }, Fu = (t1)=>{
        let e = ze(t1.inputs[0].dataType);
        t1.compute(ge(t1.inputs[0], "Relu", (r)=>`select(vec4<${e}>(0.0), ${r}, ${r} > vec4<${e}>(0.0))`));
    }, qu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Sigmoid", (e)=>`(1.0 / (1.0 + exp(-${e})))`));
    }, Ku = (t1)=>ee(t1), ju = (t1, e)=>{
        let r = ze(t1.inputs[0].dataType);
        t1.compute(ge(t1.inputs[0], "HardSigmoid", (n)=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${e.alpha} * ${n} + vec4<${r}>(${e.beta})))`, void 0, e.cacheKey));
    }, Zu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Sin", "sin"));
    }, Qu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Sinh", "sinh"));
    }, Yu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Sqrt", "sqrt"));
    }, Xu = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Tan", "tan"));
    }, Ju = (t1)=>`sign(${t1}) * (1 - exp(-2 * abs(${t1}))) / (1 + exp(-2 * abs(${t1})))`, ed = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Tanh", Ju));
    }, _o = (t1 = "f32")=>`
const fast_gelu_a: ${t1} = 0.5;
const fast_gelu_b: ${t1} = 0.7978845608028654;
const fast_gelu_c: ${t1} = 0.035677408136300125;

fn tanh_v(v: vec4<${t1}>) -> vec4<${t1}> {
  return ${Ju("v")};
}
`, wo = (t1)=>`(fast_gelu_a + fast_gelu_a * tanh_v(${t1} * (fast_gelu_c * ${t1} * ${t1} + fast_gelu_b))) * ${t1}`, td = (t1)=>{
        let e = ze(t1.inputs[0].dataType);
        t1.compute(ge(t1.inputs[0], "FastGelu", wo, _o(e), void 0, t1.inputs[0].dataType));
    }, rd = (t1, e)=>{
        let r = ze(t1.inputs[0].dataType);
        return t1.compute(ge(t1.inputs[0], "ThresholdedRelu", (n)=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`, `const thresholded_relu_alpha_ = vec4<${r}>(${e.alpha});`, e.cacheKey)), 0;
    }, nd = (t1)=>{
        t1.compute(ge(t1.inputs[0], "Log", "log"));
    }, Ih = (t1, e)=>`
const alpha = vec4<${t1}>(${e});
const one = ${t1}(1.0);
const zero = ${t1}(0.0);

fn quick_gelu_impl(x: vec4<${t1}>) -> vec4<${t1}> {
  let v = x *alpha;
  var x1 : vec4<${t1}>;
...
`, Ch = (t1)=>`quick_gelu_impl(${t1})`, od = (t1, e)=>{
        let r = ze(t1.inputs[0].dataType);
        t1.compute(ge(t1.inputs[0], "QuickGelu", Ch, Ih(r, e.alpha), e.cacheKey, t1.inputs[0].dataType));
    };
});
var Ah, Eh, ad, sd = V(()=>{
    "use strict";
    ...
    Ah = (t1)=>{
        ...
        if (![
            ...
            5120,
            10240
        ].includes(t1[0].dims[2])) throw new Error("hidden state should be 2560, 5120 or 10240");
        if (t1[1].dims.length !== 1) throw new Error("bias is expected to have 1 dimensions");
        if (t1[0].dims[2] !== t1[1].dims[0]) throw new Error("last dimension of input and bias are not the same");
    }, Eh = (t1)=>{
        let e = t1[0].dims.slice();
        e[2] = e[2] / 2;
        let r = O("input", t1[0].dataType, t1[0].dims, 4), n = O("bias", t1[0].dataType, [
            t1[0].dims[2]
        ], 4), o = U("output", t1[0].dataType, e, 4), i = k.size(e) / 4, s = we(t1[0].dataType);
        return {
            name: "BiasSplitGelu",
            getRunData: ()=>({
                    outputs: [
  ...
  const halfChannels = ${t1[0].dims[2] / 4 / 2}u;
  ...
  ${d.mainStart()}
    ...
    ${o.setByOffset("global_idx", "valueLeft * geluRight")}
        ...
        Ah(t1.inputs), t1.compute(Eh(t1.inputs));
    };
});
var kh, Ph, dt, ud, dd, ld, cd, pd, md, fd, hd, gd, bd, yd = V(()=>{
    ...
    kh = (t1, e, r, n, o, i, s, u, d, c, p, m)=>{
        ...
        return `
        ${t1.registerUniform("vec_size", "u32").declareVariables(_, T, b)}
    ...
    }, Ph = (t1, e, r, n, o, i, s = r.dataType)=>{
        let u = r.dims.map(Number), d = n.dims.map(Number), c = !k.areEqual(u, d), p = u, m = k.size(u), g = !1, y = !1, b = [
            c
        ];
        if (c) {
        ...
        t1.compute(Ph(e, o ?? "", t1.inputs[0], t1.inputs[1], r, n, i));
    }, ud = (t1)=>{
        dt(t1, "Add", (e, r)=>`${e}+${r}`);
    }, dd = (t1)=>{
        dt(t1, "Div", (e, r)=>`${e}/${r}`);
        ...
        let e = O("input", t1.inputs[0].dataType, t1.inputs[0].dims).type.value;
        dt(t1, "Pow", {
...
var zh, Dh, Bh, Mh, _d, wd, vd = V(()=>{
    ...
    oe();
    zh = (t1, e)=>{
        if (!t1 || t1.length < 1) throw new Error("too few inputs");
        let r = 0, n = t1[r], o = n.dataType, i = n.dims.length;
        t1.forEach((s, u)=>{
            if (u !== r) {
  ...
  fn calculateInputIndex(index: u32) -> u32 {
    let sizeInConcatAxis = array<u32, ${t1}u>(${e});
    for (var i: u32 = 0u; i < ${t1}; i += 1u ) {
    ...
    return ${t1}u;
        ...
        let r = t1.length, n = [];
        for(let o = 0; o < r; ++o){
            let i = e.setByOffset("global_idx", t1[o].getByIndices("indices"));
            r === 1 ? n.push(i) : o === 0 ? n.push(`if (inputIndex == ${o}u) { ${i} }`) : o === r - 1 ? n.push(`else { ${i} }`) : n.push(`else if (inputIndex == ${o}) { ${i} }`);
        }
        return n.join(`
`);
    }, Mh = (t1, e, r, n)=>{
        let o = k.size(r), i = new Array(t1.length), s = new Array(t1.length), u = 0, d = [], c = [], p = [
            {
                type: 12,
                data: o
            }
        ];
        for(let _ = 0; _ < t1.length; ++_)u += t1[_].dims[e], i[_] = u, c.push(t1[_].dims.length), s[_] = O(`input${_}`, n, c[_]), d.push("rank"), p.push({
            type: 12,
            data: i[_]
        });
        for(let _ = 0; _ < t1.length; ++_)p.push(...W(t1[_].dims));
        p.push(...W(r));
  ...
  ${(()=>{
                ...
                for(let T = 0; T < t1.length; T++)_.registerUniform(`sizeInConcatAxis${T}`, "u32");
  ...
  ${_.mainStart()}
    ...
    ${Bh(s, m)}
        ...
        let r = t1.inputs, n = r[0].dims, o = k.normalizeAxis(e.axis, n.length);
        zh(r, o);
        let i = n.slice();
        i[o] = r.reduce((u, d)=>u + (d.dims.length > o ? d.dims[o] : 0), 0);
        let s = r.filter((u)=>k.size(u.dims) > 0);
        t1.compute(Mh(s, o, i, r[0].dataType), {
            inputs: s
        });
    }, wd = (t1)=>ee({
            axis: t1.axis
    ...
    Qe = (t1, e, r = "f32")=>{
        ...
        `;
            case "":
                return "";
            default:
                throw new Error(`Unsupported activation ${t1.activation}`);
        }
    }, Ye = (t1, e)=>{
        t1.activation === "Clip" ? e.push({
            type: 1,
            data: t1.clipMax
        }, {
            type: 1,
            data: t1.clipMin
        }) : t1.activation === "HardSigmoid" ? e.push({
            type: 1,
            data: t1.alpha
        }, {
            type: 1,
            data: t1.beta
        }) : t1.activation === "LeakyRelu" && e.push({
            type: 1,
            data: t1.alpha
        });
    }, Xe = (t1, e)=>{
    ...
    ke = (t1, e)=>{
        switch(t1){
            ...
            case 4:
                return `vec4<${e}>`;
            default:
                throw new Error(`${t1}-component is not supported.`);
        }
    }, $d = (t1)=>`
      ${t1 ? "value = value + getBiasByOutputCoords(coords);" : ""}
      `;
});
var xd, Sd = V(()=>{
    "use strict";
...
var ir, on, an = V(()=>{
    ...
    ir = (t1, e, r, n, o)=>{
      ...
      if (${j(e.shape, u, e.rank)} != 1) {
        ${e.indicesSet(t1, u, j(o, u + i, n))}
      } else {
        ${e.indicesSet(t1, u, 0)}
      }`).join("")}
`;
    }, on = (t1, e, r, n, o = !1, i)=>{
        let s = t1[0].dims, u = t1[1].dims, d = s[s.length - 2], c = u[u.length - 1], p = s[s.length - 1], m = fe(c), g = fe(p), y = fe(d), b = k.size(r) / m / y, _ = t1.length > 2, T = n ? n.slice(0, -2) : r.slice(0, -2), $ = [
            k.size(T),
            d,
            c
        ], S = [
        ...
        Ye(e, S), S.push(...W(T, s, u)), _ && S.push(...W(t1[2].dims)), S.push(...W($));
        let I = (E)=>{
            let A = Qr("batch_dims", t1[0].dataType, T.length), z = O("a", t1[0].dataType, s.length, g), v = O("b", t1[1].dataType, u.length, m), R = U("output", t1[0].dataType, $.length, m), N = we(R.type.tensor), F = Qe(e, R.type.value, N), q = [
                z,
                v
            ], X = "";
            if (_) {
                let Q = o ? m : 1;
                q.push(O("bias", t1[2].dataType, t1[2].dims.length, Q)), X = `${o ? `value += bias[col / ${Q}];` : `value += ${R.type.value}(bias[row + i]);`}`;
            }
            let D = [
                {
                    name: "output_size",
...
var Rh, Uh, vo, Td, Nh, $o, Vh, ar, sn = V(()=>{
    ...
    Rh = (t1, e)=>t1 ? `
        ...
        }`, vo = (t1, e, r = "f32", n, o = !1, i = 32, s = !1, u = 32)=>{
        let d = e[1] * t1[1], c = e[0] * t1[0], p = o ? d : i, m = o ? i : d, g = p / e[0], y = i / e[1];
        if (!((o && g === 4 && t1[1] === 4 || !o && (g === 3 || g === 4)) && p % e[0] === 0 && i % e[1] === 0 && t1[0] === 4)) throw new Error(`If transposeA ${o} is true, innerElementSize ${g} and workPerThread[1] ${t1[1]} must be 4.
      Otherwise, innerElementSize ${g} must be 3 or 4.
  tileAWidth ${p} must be divisible by workgroupSize[0]${e[0]}. tileInner ${i} must be divisible by workgroupSize[1] ${e[1]}. colPerThread ${t1[0]} must be 4.`);
        return `
var<workgroup> mm_Asub: array<array<vec${g}<${r}>, ${p / g}>, ${m}>;
var<workgroup> mm_Bsub: array<array<vec4<${r}>, ${c / t1[0]}>, ${i}>;

const rowPerThread = ${t1[1]};
const colPerThread = ${t1[0]};
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, Nh = (t1)=>t1 ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", $o = (t1, e, r = "f32", n, o = !1, i = 32, s = !1, u = 32, d = !1)=>{
        let c = t1[1] * e[1], p = t1[0] * e[0], m = o ? c : i, g = o ? i : c;
...
`;
        ...
        return `
    fn mm_readA(batch: i32, row: i32, colIn: i32, batchIndices: ${i.type.indices}) -> ${ke(t1, c)} {
      var value = ${ke(t1, c)}(0.0);
      let col = colIn * ${t1};
    ...
    fn mm_readB(batch: i32, row: i32, colIn: i32, batchIndices: ${i.type.indices}) -> ${ke(t1, c)} {
      var value = ${ke(t1, c)}(0.0);
      let col = colIn * ${t1};
    ...
    fn mm_write(batch: i32, row: i32, colIn: i32, valueIn: ${ke(t1, c)}) {
      let col = colIn * ${t1};
      if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
        var value = valueIn;
        let coords = vec3<i32>(batch, row, colIn);
        ${e ? `value = value + ${o ? "bias[colIn]" : `${ke(t1, c)}(bias[row])`};` : ""}
        ${r}
    ...
    `;
        ...
        let s = t1[0].dims, u = t1[1].dims, d = s.slice(0, -2), c = u.slice(0, -2), p = n ? n.slice(0, -2) : r.slice(0, -2), m = k.size(p), g = s[s.length - 2], y = s[s.length - 1], b = u[u.length - 1], _ = y % 4 === 0 && b % 4 === 0, T = g <= 8 ? [
            4,
            1,
            1
        ] : [
        ...
        F && (R.push(...W(t1[2].dims)), N.push("rank")), R.push(...W(v));
        let q = (X)=>{
            let D = p.length, L = Qr("batchDims", t1[0].dataType, D, 1), Q = we(t1[0].dataType), Y = O("a", t1[0].dataType, E, S), Z = O("b", t1[1].dataType, z, S), te = U("result", t1[0].dataType, v.length, S), ae = [
                Y,
                Z
            ];
            if (F) {
                let G = o ? S : 1;
                ae.push(O("bias", t1[2].dataType, t1[2].dims.length, G));
            }
            let le = [
                {
                    name: "dim_a_outer",
...
var Lh, Id, Cd = V(()=>{
    ...
    Sd();
    sn();
    Lh = (t1, e, r, n, o = !1, i, s = 4, u = 4, d = 4, c = "f32")=>{
        let p = (N)=>{
            switch(N){
                case 1:
    ...
    let coords = vec4<i32>(
      ...
      col / outWidth,
      col % outWidth);
    `, b = t1 ? "i32(uniforms.x_shape[1])" : "i32(uniforms.x_shape[2])", _ = t1 ? "i32(uniforms.x_shape[2])" : "i32(uniforms.x_shape[3])", T = t1 ? "row" : "col", x = t1 ? "col" : "row", $ = `
    let inChannels = i32(uniforms.w_shape[2]);
    let outWidth = ${t1 ? "i32(uniforms.result_shape[2])" : "i32(uniforms.result_shape[3])"};
    ...
    return ${ke(s, c)}(0.0);`, I = t1 ? n && r ? m(u) : `
    let col = colIn * ${u};
    if (row < uniforms.dim_inner && col < uniforms.dim_b_outer) {
      ${m(u)}
    }
    ...
    return ${ke(u, c)}(0.0);`, E = ke(d, c), A = t1 ? ke(s, c) : ke(u, c), z = t1 ? ke(u, c) : ke(s, c), v = Qe(i, E, c);
        return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${E}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
    ...
    }, Id = (t1, e, r, n, o, i, s, u, d)=>{
        let c = e.format === "NHWC", p = c ? t1[0].dims[3] : t1[0].dims[1], m = r[0], g = c ? r[2] : r[3], y = c ? r[1] : r[2], b = c ? r[3] : r[1], _ = c && (p % 4 === 0 || p % 3 === 0) && b % 4 === 0, T = c ? b : g * y, x = c ? g * y : b, $ = [
            8,
            8,
            1
        ], S = n <= 8 ? [
        ...
        Ye(e, X), X.push(...W(t1[0].dims, t1[1].dims));
        let D = [
            "rank",
            "rank"
        ];
        s && (X.push(...W(t1[2].dims)), D.push("rank")), X.push(...W(r));
        let L = (Q)=>{
            let Y = [
                {
                    name: "dim_a_outer",
            ...
            Xe(e, Y);
            let Z = _ ? 4 : 1, te = we(t1[0].dataType), ae = `
      ...
      }`, le = O("x", t1[0].dataType, t1[0].dims.length, E === 3 ? 1 : E), Me = O("w", t1[1].dataType, t1[1].dims.length, Z), ve = [
                le,
                Me
            ], M = U("result", t1[0].dataType, r.length, Z);
            if (s) {
                let G = O("bias", t1[2].dataType, t1[2].dims.length, Z);
                ve.push(G), ae += `
...
var Wh, Ad, un, Gh, Ed, Hh, kd, Pd, Od = V(()=>{
    ...
    Wh = (t1)=>{
        let e = 1;
        for(let r = 0; r < t1.length; r++)e *= t1[r];
        return e;
    }, Ad = (t1)=>typeof t1 == "number" ? [
            t1,
            t1,
            t1
        ] : t1, un = (t1, e)=>e <= 1 ? t1 : t1 + (t1 - 1) * (e - 1), Gh = (t1, e, r, n = 1)=>{
        let o = un(e, n);
        return Math.floor((t1[0] * (r - 1) - r + o) / 2);
    }, Ed = (t1, e, r, n, o)=>{
        o == null && (o = Gh(t1, e[0], n[0]));
        let i = [
            0,
            0,
            0,
        ...
        for(let s = 0; s < 3; s++)t1[s] + 2 * o >= e[s] && (i[s] = Math.trunc((t1[s] - e[s] + 2 * o) / n[s] + 1));
        return i;
    }, Hh = (t1, e, r, n, o, i, s, u, d, c)=>{
        let p, m, g, y;
        if (t1 === "VALID" && (t1 = 0), typeof t1 == "number") {
            p = {
                top: t1,
                bottom: t1,
                left: t1,
            ...
            if (!t1.every((_, T, x)=>_ === x[0])) throw Error(`Unsupported padding parameter: ${t1}`);
            p = {
                top: t1[0],
                bottom: t1[1],
                left: t1[2],
        ...
        } else throw Error(`Unknown padding parameter: ${t1}`);
        return {
            padInfo: p,
            outDepth: m,
            outHeight: g,
    ...
    }, kd = (t1, e, r, n, o, i = !1, s = "channelsLast")=>{
        let u, d, c, p, m;
        if (s === "channelsLast") [u, d, c, p, m] = t1;
        else if (s === "channelsFirst") [u, m, d, c, p] = t1;
        ...
        let s = i === "channelsLast", u = s ? t1[0].dims[3] : t1[0].dims[1], d = !1, c = [
            64,
            1,
            1
        ], p = {
        ...
        let g = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 1, y = k.size(r), b = [
            {
                type: 12,
                data: y
            },
        ...
        Ye(e, b), b.push(...W(t1[0].dims, t1[1].dims));
        let _ = [
            "rank",
            "rank"
        ], T = t1.length === 3;
        T && (b.push(...W(t1[2].dims)), _.push("rank")), b.push(...W(r));
        let x = ($)=>{
            let S = [
                {
                    name: "output_size",
            ...
            Xe(e, S);
            let I = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 1, E = we(t1[0].dataType), A = O("x", t1[0].dataType, t1[0].dims.length, ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : g), z = O("W", t1[1].dataType, t1[1].dims.length, I), v = [
                A,
                z
            ], R = U("result", t1[0].dataType, r.length, I), N = "";
            if (T) {
                let X = O("bias", t1[2].dataType, t1[2].dims.length, I);
                v.push(X), N += `
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : E} {
          return bias[${s ? j("coords", 4, 5) : j("coords", 1, 5)}${("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ""}];
        }`;
            }
...
var zd, Dd, Bd = V(()=>{
    ...
    St();
    zd = (t1, e, r, n)=>{
        let o = t1.length > 2, i = o ? "value += b[output_channel];" : "", s = t1[0].dims, u = t1[1].dims, d = e.format === "NHWC", c = d ? r[3] : r[1], p = c / e.group, m = d && p >= 4 ? fe(c) : 1, g = k.size(r) / m, y = [
            {
                type: 12,
                data: g
            },
        ...
        let _ = (T)=>{
            let x = U("output", t1[0].dataType, r.length, m), $ = we(x.type.tensor), S = Qe(e, x.type.value, $), I = O("x", t1[0].dataType, s.length), E = O("w", t1[1].dataType, u.length, m), A = [
                I,
                E
            ];
            o && A.push(O("b", t1[2].dataType, t1[2].dims, m));
            let z = [
                {
                    name: "output_size",
                    type: "u32"
  ...
  ${T.mainStart()}
    ...
    ${x.setByOffset("global_idx", "value")}
        ...
        let o = t1.length > 2, i = fe(r[3]), s = fe(r[2]), u = k.size(r) / i / s, d = [
            t1[0].dims[0],
            t1[0].dims[1],
            t1[0].dims[2],
            t1[0].dims[3] / i
        ...
        let g = (s - 1) * e.strides[1] + c[1], y = (b)=>{
            let _ = U("output", t1[0].dataType, p.length, i), T = we(_.type.tensor), x = Qe(e, _.type.value, T), $ = O("x", t1[0].dataType, d.length, i), S = O("w", t1[1].dataType, c.length, i), I = [
                $,
                S
            ];
            o && I.push(O("b", t1[2].dataType, t1[2].dims, i));
...
var Fh, xo, qh, So, To, Md, Kh, jh, Io, Rd = V(()=>{
    ...
    pt();
    Fh = (t1, e, r, n, o, i)=>{
        let s = t1[0], u = t1.slice(i ? 1 : 2, i ? 3 : 4), d = u.length, c = e[0], m = e.slice(2).map((b, _)=>b + (b - 1) * (r[_] - 1)), y = u.map((b, _)=>b + n[_] + n[_ + d]).map((b, _)=>Math.floor((b - m[_] + o[_]) / o[_]));
        ...
        if (!t1 || t1.length !== 2 && t1.length !== 3) throw new Error("Conv requires 2 or 3 inputs");
        if (t1[0].dims.length > 5) throw new Error("greater than 5D is not supported");
        if (t1[0].dims.length !== t1[1].dims.length) throw new Error("filter does not have same dimension as input");
        let r = t1[0].dims[e.format === "NHWC" ? t1[0].dims.length - 1 : 1], n = t1[1].dims[1] * e.group;
        if (r !== n) throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");
        if (t1.length === 3 && (t1[2].dims.length !== 1 || t1[1].dims[0] !== t1[2].dims[0])) throw new Error("invalid bias");
        let o = t1[0].dims.length - 2;
        ...
        if (e.kernelShape.length !== 0 && e.kernelShape.length !== t1[1].dims.length - 2) throw new Error("invalid kernel shape");
    }, So = (t1, e)=>{
        let r = t1.kernelShape.slice();
        ...
        let n = t1.pads.slice();
        zt.adjustPadsBasedOnAutoPad(e[0].dims, t1.strides, t1.dilations, r, n, t1.format === "NHWC", t1.autoPad);
        let o = Object.assign({}, t1);
        return Object.assign(o, {
            kernelShape: r,
            pads: n
        }), o;
    }, To = (t1)=>{
        let e = rn(t1), r = t1.format, n = [
            "NOTSET",
            "VALID",
            "SAME_UPPER",
            "SAME_LOWER"
        ][t1.auto_pad], o = t1.dilations, i = t1.group, s = t1.kernel_shape, u = t1.pads, d = t1.strides, c = t1.w_is_const();
        return {
            autoPad: n,
            format: r,
            dilations: o,
            ...
            wIsConst: c,
            ...e,
            cacheKey: `${t1.format};${e.activation};`
        };
    }, Md = (t1, e, r, n)=>{
        ...
        if (r.group !== 1) {
            ...
            if (o) {
                let v = t1.kernelCustomData.wT ?? t1.compute(De(e[1], xo), {
                    inputs: [
                        1
                    ],
                    outputs: [
                ...
                r.wIsConst && !t1.kernelCustomData.wT && (t1.kernelCustomData.wT = v), A.push(v);
            } else A.push(e[1]);
            e.length === 3 && A.push(e[2]), !t1.adapterInfo.isArchitecture("ampere") && o && e[1].dims[0] === r.group && e[1].dims[1] === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 ? t1.compute(Dd(A, r, i, n), {
                inputs: A
            }) : t1.compute(zd(A, r, i, n), {
                inputs: A
            });
            return;
        }
        ...
        if (_ || p === 1 && m === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
            let A = i[0], z, v, R, N = [];
            if (o) {
                let X = t1.kernelCustomData.wT ?? t1.compute(De(e[1], xo), {
                    inputs: [
                        1
                    ],
                    outputs: [
                ...
                if (r.wIsConst && !t1.kernelCustomData.wT && (t1.kernelCustomData.wT = X), _) {
                    let D = u * d * c;
                    z = e[0].reshape([
                        1,
                        A,
            ...
            F < 8 && q < 8 ? t1.compute(on(N, r, i, R, o, n), {
                inputs: N
            }) : t1.compute(ar(N, r, i, R, o, n), {
                inputs: N
            });
            return;
        }
        let T = !0, x = t1.kernelCustomData.wT ?? t1.compute(De(e[1], xo), {
            inputs: [
                1
            ],
            outputs: [
        ...
        r.wIsConst && !t1.kernelCustomData.wT && (t1.kernelCustomData.wT = x);
        let $ = [
            e[0],
            x
        ];
        ...
        t1.compute(Id($, r, i, S, I, E, s, T, n), {
            inputs: $
        });
    }, Kh = (t1, e)=>{
        let r = e.format === "NHWC", n = [
            t1.inputs[0].reshape(r ? [
                t1.inputs[0].dims[0],
                1,
                t1.inputs[0].dims[1],
                t1.inputs[0].dims[2]
        ...
        t1.inputs.length === 3 && n.push(t1.inputs[2]);
        let o = [
            0,
            e.pads[0],
            0,
        ...
        if (qh(t1.inputs, e), t1.inputs[0].dims.length === 3) Kh(t1, e);
        else if (t1.inputs[0].dims.length === 5) jh(t1, t1.inputs, e);
        else {
            let r = So(e, t1.inputs);
            Md(t1, t1.inputs, r);
        }
    };
});
var Ud, Nd = V(()=>{
    ...
    oe();
    Ud = (t1, e, r)=>{
        let n = t1.length > 2, o = e.outputShape, i = e.format === "NHWC", s = e.group, u = t1[1].dims, d = u[2] / s, c = u[3], p = i ? fe(d) : 1, m = i && c === 1 && d >= 4, g = m ? Math.floor(d / 4) * 4 : Math.floor(d / p) * p, y = d - g, b = i ? fe(c) : 1, _ = i ? c === 1 ? p : b : 1, T = k.size(o) / b, x = [
            Math.ceil(T / 64),
            1,
            1
        ];
        ...
        let $ = [
            ...
            ...W(t1[0].dims, t1[1].dims)
        ];
        n && (v.push(...W(t1[2].dims)), $.push("rank")), v.push(...W(o));
        let R = (N)=>{
            let F = [
                {
                    name: "output_size",
            ...
            ], q = we(t1[0].dataType), X = i ? 1 : 2, D = i ? 2 : 3, L = i ? 3 : 1, Q = O("W", t1[1].dataType, t1[1].dims.length, _), Y = O("Dy", t1[0].dataType, t1[0].dims.length, p), Z = [
                Y,
                Q
            ];
            n && Z.push(O("bias", t1[2].dataType, [
                o[L]
            ].length, b));
            let te = U("result", t1[0].dataType, o.length, b), ae = ()=>{
                let ve = "";
                if (m) p === 4 ? ve += `
...
var Zh, Qh, Yh, Vd, Ld, Xh, Wd, Jh, Gd, Hd = V(()=>{
    ...
    St();
    pt();
    Zh = (t1, e, r, n, o, i)=>(t1 - 1) * e + r + (n - 1) * o + 1 - i, Qh = (t1, e, r, n, o)=>{
        let i = Math.floor(t1 / 2);
        e === "SAME_UPPER" ? (r[n] = i, r[o] = t1 - i) : e === "SAME_LOWER" && (r[n] = t1 - i, r[o] = i);
    }, Yh = (t1, e, r, n, o, i, s, u, d, c)=>{
        let p = t1.length - 2, m = c.length === 0;
        d.length < p && d.push(...Array(p - d.length).fill(0));
        let g = t1[0], y = e[u ? 3 : 1] * o;
        for(let b = 0, _ = t1.length - p - (u ? 1 : 0); b < p; ++b, ++_){
            let T = t1[_], x = m ? T * s[b] : c[b], $ = Zh(T, s[b], i[b], e[_], r[b], x);
            Qh($, n, i, b, b + p), m && c.push(s[b] * (T - 1) + d[b] + (e[_] - 1) * r[b] + 1 - i[b] - i[b + p]);
        }
        c.splice(0, 0, g), c.splice(u ? 3 : 1, 0, y);
    }, Vd = (t1, e)=>{
        let r = t1.kernelShape.slice();
        if (t1.kernelShape.length === 0 || t1.kernelShape.reduce((m, g)=>m * g, 1) === 0) {
            r.length = 0;
            for(let m = 2; m < e[1].dims.length; ++m)r.push(e[1].dims[m]);
        }
        let n = t1.format === "NHWC";
        r.splice(0, 0, e[1].dims[0]), r.splice(n ? 3 : 1, 0, e[1].dims[1]);
        let o = t1.pads.slice(), i = t1.outputShape.slice(), s = t1.outputPadding.slice(), u = e[0].dims, d = t1.dilations.slice();
        if (d.reduce((m, g)=>m + g, 0) === 0) {
            let m = e[0].dims.length - 2;
            d = new Array(m).fill(1);
        }
        let c = t1.strides.slice();
        if (c.reduce((m, g)=>m + g, 0) === 0) {
            let m = e[0].dims.length - 2;
            c = new Array(m).fill(1);
        }
        Yh(u, r, d, t1.autoPad, t1.group, o, c, n, s, i);
        let p = Object.assign({}, t1);
        ...
        let e = rn(t1), r = t1.format, n = [
            ...
            "SAME_UPPER",
            "SAME_LOWER"
        ][typeof t1.autoPad > "u" ? 0 : t1.autoPad], o = t1.dilations, i = t1.group ?? 1, s = t1.kernelShape, u = t1.pads, d = t1.strides, c = t1.wIsConst(), p = t1.outputPadding, m = t1.outputShape;
        return {
            autoPad: n,
            format: r,
            dilations: o,
        ...
        if (!t1 || t1.length !== 2 && t1.length !== 3) throw new Error("Conv requires 2 or 3 inputs");
        if (t1[0].dims.length !== 4 && t1[0].dims.length !== 3) throw new Error("currently only support 2-dimensional conv");
        if (t1[0].dims.length !== t1[1].dims.length) throw new Error("filter does not have same dimension as input");
        let r = t1[0].dims[e.format === "NHWC" ? t1[0].dims.length - 1 : 1], n = t1[1].dims[0];
        if (r !== n) throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");
        let o = t1[1].dims[1] * e.group;
        if (t1.length === 3 && (t1[2].dims.length !== 1 || t1[2].dims[0] !== o)) throw new Error("invalid bias");
        let i = t1[0].dims.length - 2;
        ...
        if (e.kernelShape.reduce((p, m)=>p + m, 0) > 0 && e.kernelShape.length !== 0 && e.kernelShape.length !== t1[1].dims.length - 2) throw new Error("invalid kernel shape");
        if (e.outputShape.length !== 0 && e.outputShape.length !== t1[0].dims.length - 2) throw new Error("invalid output shape");
    }, Wd = (t1, e, r, n)=>{
        let o = t1.kernelCustomData.wT ?? t1.compute(De(e[1], [
            2,
            3,
            0,
            1
        ...
        r.wIsConst && !t1.kernelCustomData.wT && (t1.kernelCustomData.wT = o);
        let i = [
            e[0],
            o
        ];
        e.length === 3 && i.push(e[2]), t1.compute(Ud(i, r, n), {
            inputs: i
        });
    }, Jh = (t1, e)=>{
        let r = e.format === "NHWC", n = [
        ...
        if (Xh(t1.inputs, e), t1.inputs[0].dims.length === 3) Jh(t1, e);
        else {
            let r = Vd(e, t1.inputs);
            Wd(t1, t1.inputs, r);
        }
    };
});
var eg, Fd, qd, Kd = V(()=>{
    ...
    oe();
    eg = (t1, e, r, n)=>{
        let o = k.size(e), i = e.length, s = O("input", t1, i), u = U("output", t1, i), d = r.dataType === 6 ? r.getInt32Array()[0] : Number(r.getBigInt64Array()[0]), c = k.normalizeAxis(d, i), p = (m)=>{
        ...
        let r = t1.inputs[0].dims, n = t1.inputs[0].dataType, o = t1.inputs[1];
        t1.compute(eg(n, r, o, e), {
            inputs: [
                0
            ]
        });
    }, qd = (t1)=>{
        let e = t1.exclusive === 1, r = t1.reverse === 1;
        return ee({
            exclusive: e,
            reverse: r
        });
...
var tg, rg, ng, jd, Zd, Qd = V(()=>{
    ...
    oe();
    tg = (t1)=>{
        if (!t1 || t1.length !== 1) throw new Error("DepthToSpace requires 1 input.");
        if (t1[0].dims.length !== 4) throw new Error("DepthToSpace requires 4D input.");
    }, rg = (t1, e, r, n)=>{
        let o = [];
        o.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);
        for(let i = 0; i < e; ++i)o.push(r.indicesSet("a", t1[i], `i[${i}]`));
        return o.push("return a;}"), o.join(`
`);
    }, ng = (t1, e)=>{
        let r, n, o, i, s, u, d = e.format === "NHWC", c = e.blocksize, p = e.mode === "DCR";
        d ? ([r, n, o, i] = t1.dims, s = p ? [
            r,
            n,
            o,
            c,
        ...
        let m = t1.reshape(s), g = m.dims.length, y = t1.dataType, b = O("a", y, g), _ = U("output", y, g), T = (x)=>`
  ...
  ${x.mainStart()}
    ...
    ${_.setByOffset("global_idx", b.getByIndices("aIndices"))}
        ...
        return {
            name: "DepthToSpace",
            shaderCache: {
                hint: `${t1.dims};${e.blocksize};${e.mode}`,
                inputDependencies: [
                    "rank"
                ]
            },
        ...
        tg(t1.inputs), t1.compute(ng(t1.inputs[0], e));
    }, Zd = (t1)=>ee({
            blocksize: t1.blocksize,
            mode: t1.mode,
            format: t1.format
        });
});
var Co, dn, Yd, og, ig, Ao, Eo, Xd, ag, Jd, el, tl = V(()=>{
    ...
    }, Xd = (t1)=>t1 + "_max", ag = (t1, e, r, n)=>{
        let i = t1.map((p)=>p.length).map((p, m)=>O(`input${m}`, e, p)), s = k.size(n), u = U("output", e, n.length), d = [
            ...r.symbolToInfo.keys()
...
`)};
        ...
        let r = new Eo(t1.inputs, e.equation), n = r.outputDims, o = t1.inputs.map((i, s)=>i.dims);
        t1.compute(ag(o, t1.inputs[0].dataType, r, n));
    }, el = (t1)=>{
        let e = t1.equation.replace(/\s+/g, "");
        return ee({
            equation: e
        });
    };
...
var sg, rl, ug, dg, nl, ol = V(()=>{
    ...
    oe();
    sg = (t1)=>{
        if (!t1 || t1.length !== 2) throw new Error("Expand requires 2 input.");
        let e = t1[0].dims, r = Array.from(t1[1].getBigInt64Array(), Number), n = r.length < e.length ? 0 : r.length - e.length, o = e.length < r.length ? 0 : e.length - r.length;
        for(; n < r.length && o < e.length; ++n, ++o)if (r[n] !== e[o] && r[n] !== 1 && e[o] !== 1) throw new Error("Expand requires shape to be broadcastable to input");
    }, rl = (t1, e)=>{
        let r = t1.length - e.length, n = [];
        for(let o = 0; o < r; ++o)n.push(t1[o]);
        for(let o = 0; o < e.length; ++o)n.push(e[o] === 1 ? t1[o + r] : e[o]);
        return n;
    }, ug = (t1, e)=>t1.length > e.length ? rl(t1, e) : rl(e, t1), dg = (t1)=>{
        let e = t1[0].dims, r = Array.from(t1[1].getBigInt64Array(), Number), n = ug(e, r), o = t1[0].dataType, i = o === 9 || k.size(e) === 1, s = o === 9 || e.length > 0 && e[e.length - 1] % 4 === 0 ? 4 : 1, u = i || n.length > 0 && n[n.length - 1] % 4 === 0 ? 4 : 1, d = Math.ceil(k.size(n) / u), c = (m)=>{
    ...
    ${b}`;
        ...
        sg(t1.inputs), t1.compute(dg(t1.inputs), {
            inputs: [
                0
            ]
        });
...
var lg, il, al = V(()=>{
    ...
    tn();
    lg = (t1)=>{
        let e = t1[0].dataType, r = k.size(t1[0].dims), n = k.size(t1[1].dims), o = n % 4 === 0, i = (s)=>{
            let u = O("x", e, [
                1
            ], 4), d = O("bias", e, [
                1
    ...
    ${s.mainStart(Dt)}
      ...
      ${c.setByOffset("global_idx", wo("x_in"))}
        ...
        t1.inputs.length < 2 || k.size(t1.inputs[1].dims) === 0 ? td(t1) : t1.compute(lg(t1.inputs));
    };
});
var cg, pg, sl, ul, dl = V(()=>{
    ...
    oe();
    cg = (t1)=>{
        if (!t1 || t1.length !== 2) throw new Error("Gather requires 2 inputs.");
    }, pg = (t1, e)=>{
        let r = t1[0].dims, n = t1[1].dims, o = r.length, i = k.normalizeAxis(e.axis, o), s = r.slice(0);
        s.splice(i, 1, ...n);
        let u = r[i], d = t1[0].dataType === 9 ? 4 : 1, c = Math.ceil(k.size(s) / d), p = [
            {
                type: 12,
                data: c
            },
            ...
            ...W(t1[0].dims, t1[1].dims, s)
        ], m = (g)=>{
            let y = O("data", t1[0].dataType, t1[0].dims.length, d), b = O("inputIndices", t1[1].dataType, t1[1].dims.length), _ = U("output", t1[0].dataType, s.length, d), T = ($)=>{
      ...
      ${g.mainStart()}
        ...
        let r = t1.inputs;
        cg(r), t1.compute(pg(t1.inputs, e));
    };
});
var mg, ll, cl, pl = V(()=>{
    "use strict";
    ...
    mg = (t1, e, r, n, o, i, s, u, d)=>{
        ...
        c.push(...W(e.dims, p));
        let m = (g)=>{
            let y = O("indices_data", e.dataType, e.dims.length), b = U("input_slice_offsets_data", 12, 1, 1), _ = [
                y,
                b
            ], T = [
                {
  ...
  ${g.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
        ...
        let r = t1.inputs, n = r[0].dims, o = r[0].dataType, i = r[1].dims, s = i[i.length - 1], u = k.sizeToDimension(i, i.length - 1), d = k.sizeFromDimension(n, e.batchDims + s), c = k.sizeToDimension(n, e.batchDims), p = k.sizeFromDimension(n, e.batchDims), m = u / c, g = new Array(s), y = d;
        for(let I = 0; I < s; ++I)g[s - 1 - I] = y, y *= n[e.batchDims + s - 1 - I];
        let b = mg(t1, r[1], g, e.batchDims, n, u, m, p, s), _ = e.batchDims + s;
...
var fg, hg, ml, fl, hl = V(()=>{
    ...
    oe();
    fg = (t1, e)=>{
        if (t1.length < 3 || t1.length > 4) throw new Error("GatherBlockQuantized requires 3 or 4 inputs.");
        let r = k.normalizeAxis(e.quantizeAxis, t1[0].dims.length), n = e.blockSize, o = t1[0], i = t1[2], s = t1.length === 4 ? t1[3] : void 0;
        ...
        let r = t1[0].dims, n = t1[1].dims, o = r.length, i = k.normalizeAxis(e.gatherAxis, o), s = k.normalizeAxis(e.quantizeAxis, o), u = r.slice(0);
        u.splice(i, 1, ...n);
        let d = k.size(u), c = t1[2].dataType, m = t1[0].dataType === 22, g = [
            {
                type: 12,
                data: d
            },
            ...
            ...W(...t1.map((b, _)=>b.dims), u)
        ], y = (b)=>{
            let _ = O("data", t1[0].dataType, t1[0].dims.length), T = O("inputIndices", t1[1].dataType, t1[1].dims.length), x = O("scales", t1[2].dataType, t1[2].dims.length), $ = t1.length > 3 ? O("zeroPoint", t1[3].dataType, t1[3].dims.length) : void 0, S = U("output", c, u.length), I = [
                _,
                T,
                x
            ];
        ...
        return {
            ...
            shaderCache: {
                hint: `${e.cacheKey};${t1.filter((b, _)=>_ !== 1).map((b)=>b.dims.join("_")).join(";")}`,
        ...
        let r = t1.inputs;
        fg(r, e), t1.compute(hg(t1.inputs, e));
    }, fl = (t1)=>ee({
            blockSize: t1.blockSize,
            gatherAxis: t1.gatherAxis,
            quantizeAxis: t1.quantizeAxis
        });
});
var gg, bg, gl, bl, yl = V(()=>{
    ...
    oe();
    gg = (t1)=>{
        if (!t1 || t1.length !== 2) throw new Error("GatherElements requires 2 inputs.");
        if (t1[0].dims.length < 1) throw new Error("GatherElements requires that the data input be rank >= 1.");
        if (t1[0].dims.length !== t1[1].dims.length) throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`);
    }, bg = (t1, e)=>{
        let r = t1[0].dims, n = t1[0].dataType, o = r.length, i = t1[1].dims, s = t1[1].dataType, u = k.normalizeAxis(e.axis, o), d = r[u], c = i.slice(0), p = k.size(c), m = O("input", n, o), g = O("indicesInput", s, i.length), y = U("output", n, c.length), b = [
            {
                type: 12,
                data: p
            },
      ...
      ${y.setByOffset("global_idx", "value")};
        ...
        let r = t1.inputs;
        gg(r), t1.compute(bg(t1.inputs, e));
    };
});
var yg, _g, _l, wl, vl = V(()=>{
    ...
    oe();
    yg = (t1)=>{
        if (!t1) throw new Error("Input is missing");
        if (t1.length < 2 || t1.length > 3) throw new Error("Invaid input number.");
        if (t1.length === 3 && t1[2].dims.length > 2) throw new Error("Invalid input shape of C");
        if (t1[0].dataType !== t1[1].dataType || t1.length === 3 && t1[0].dataType !== t1[2].dataType) throw new Error("Input types are mismatched");
    }, _g = (t1, e)=>{
        let r = t1[0].dims.slice(), n = t1[1].dims.slice(), [o, i, s] = Wr.getShapeOfGemmResult(r, e.transA, n, e.transB, t1.length === 3 ? t1[2].dims : void 0), u = [
            o,
            i
        ];
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        let d = 16, c = Math.ceil(i / d), p = Math.ceil(o / d), m = !0, g = k.size(u), y = [
            {
                type: 12,
        ...
        t1.length === 3 && (y.push(...W(t1[2].dims)), b.push("rank")), y.push(...W(u));
        let _ = (x)=>{
            let $ = "";
            ...
            let S = e.alpha === 1 ? "" : "value *= uniforms.alpha;", I = O("a", t1[0].dataType, t1[0].dims), E = O("b", t1[1].dataType, t1[1].dims), A = I.type.value, z = null, v = [
                I,
                E
            ];
            t1.length === 3 && (z = O("c", t1[2].dataType, t1[2].dims.length), v.push(z));
            let R = U("output", t1[0].dataType, u.length);
            v.push(R);
            let N = [
                {
                    name: "output_size",
  ...
  ${x.mainStart()}
    ...
    output[global_idx] = value;
            ...
            let $ = O("a", t1[0].dataType, t1[0].dims), S = O("b", t1[1].dataType, t1[1].dims), I = null, E = [
                $,
                S
            ];
            t1.length === 3 && (I = O("c", t1[2].dataType, t1[2].dims.length), E.push(I));
            let A = U("output", t1[0].dataType, u.length);
            E.push(A);
            let z = [
                {
                    name: "num_tile_n",
  ...
  ${x.mainStart([
    ...
    if (m < uniforms.M && n < uniforms.N) {
      output[m * uniforms.N + n] = value;
        ...
        let e = t1.transA, r = t1.transB, n = t1.alpha, o = t1.beta;
        return {
            transA: e,
            transB: r,
            alpha: n,
            beta: o,
            cacheKey: `${t1.transA};${t1.transB};${t1.alpha === 1}`
        };
    }, wl = (t1, e)=>{
        yg(t1.inputs), t1.compute(_g(t1.inputs, e));
    };
});
var mt, Tt, Ht, Ft, wg, vg, $g, xg, Sg, Tg, Ig, Cg, $l, xl, Sl = V(()=>{
    ...
    [mt, Tt, Ht, Ft] = [
        ...
        if (t1[0].dims.length !== 4) throw new Error("only 4-D tensor is supported.");
        if (t1[0].dims.length !== t1[1].dims.length) throw new Error("input dimensions must be equal to grid dimensions");
        if (t1[0].dims.length - 2 !== t1[1].dims[t1[1].dims.length - 1]) throw new Error(`last dimension of grid must be equal to ${t1[0].dims.length - 2}`);
        if (t1[0].dims[0] !== t1[1].dims[0]) throw new Error("grid batch size must match input batch size");
    }, vg = `
...
`, $g = (t1)=>`
  fn gs_bicubic_interpolate(p: mat4x4<${t1}>, x: f32, y: f32) -> ${t1} {
    var v: vec4<f32>;
    ...
    let pixel = ${t1}(coeffs[0] * v[0] + coeffs[1] * v[1] + coeffs[2] * v[2] + coeffs[3] * v[3]);
    return pixel;
  }
`, xg = (t1)=>`
...
`, Tg = (t1, e, r)=>`
  fn pixel_at_grid(r: i32, c: i32, H: i32, W: i32, batch: u32, channel: u32, border: vec4<f32>) -> ${e} {
    ...
    return ${t1.getByIndices("indices")};
  }
`, Ig = (t1, e, r)=>(()=>{
            switch(r.mode){
                case "nearest":
        ...
        })() + `${t1.setByOffset("global_idx", "result")}`, Cg = (t1, e)=>{
        let r = O("x", t1[0].dataType, t1[0].dims.length), n = [
            t1[1].dims[0],
            t1[1].dims[1],
            t1[1].dims[2]
        ], o = O("grid", t1[1].dataType, n.length, 2), i = [
            t1[0].dims[0],
            t1[0].dims[1],
            t1[1].dims[1],
            t1[1].dims[2]
        ...
        let s = U("output", t1[0].dataType, i.length), u = r.type.value, d = k.size(i), c = [
            {
                type: 12,
                data: d
            },
  ...
  ${m.mainStart()}
    ${m.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${Ig(s, u, e)}
        ...
        wg(t1.inputs), t1.compute(Cg(t1.inputs, e));
    }, xl = (t1)=>ee({
            alignCorners: t1.align_corners,
            mode: t1.mode,
            paddingMode: t1.padding_mode,
            format: t1.format
        });
});
var Ue, kg, Il, Tl, Pg, sr, Cl, ko = V(()=>{
    ...
    oe();
    pt();
    Ue = (t1, e)=>t1.length > e && t1[e].dims.length > 0 ? t1[e] : void 0, kg = (t1, e)=>{
        let r = t1[0], n = Ue(t1, 1), o = Ue(t1, 2), i = Ue(t1, 3), s = Ue(t1, 4), u = Ue(t1, 5), d = Ue(t1, 6), c = Ue(t1, 7);
        ...
        let u = [
            ...
            let g = U("qkv_with_bias", e.dataType, u), y = O("qkv", e.dataType, u), b = O("bias", r.dataType, u), _ = [
                {
                    name: "output_size",
                    type: "u32"
                },
  ...
  ${m.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
        ...
        if (s && k.size(s.dims) > 0) {
            ...
            return d = Pg(t1, i, s, e, n, r * o, u), d = d.reshape([
                e,
                n,
                r,
                o
            ]), r === 1 || n === 1 ? d : t1.compute(De(d, Tl.perm), {
                inputs: [
                    d
                ],
                outputs: [
        ...
        let r = kg(t1.inputs, e), n = t1.inputs[0], o = Ue(t1.inputs, 1), i = Ue(t1.inputs, 2), s = Ue(t1.inputs, 3), u = Ue(t1.inputs, 4), d = Ue(t1.inputs, 5), c = Ue(t1.inputs, 6), p = Ue(t1.inputs, 7);
        ...
        let m = o && i && o.dims.length === 4 && i.dims.length === 4, g = sr(t1, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, n, s, 0);
        if (m) return Gt(t1, g, o, i, u, void 0, c, p, d, r);
        if (!o || !i) throw new Error("key and value must be provided");
        let y = sr(t1, r.batchSize, r.numHeads, r.kvSequenceLength, r.headSize, o, s, r.hiddenSize), b = sr(t1, r.batchSize, r.numHeads, r.kvSequenceLength, r.vHeadSize, i, s, 2 * r.hiddenSize);
        Gt(t1, g, y, b, u, void 0, c, p, d, r);
    };
});
var Og, zg, Dg, Bg, Po, Al, El, Oo = V(()=>{
    ...
    Og = (t1)=>{
        ...
        return t1[1].dims[0] > 0 && (t1[1].getBigInt64Array().forEach((o)=>r.push(Number(o))), n = r.length), ee({
            numOutputs: n,
            axis: e.axis,
            splitSizes: r
        });
...
fn calculateOutputIndex(index: u32) -> u32 {
    for (var i: u32 = 0u; i < ${t1}u; i += 1u ) {
    if (index < ${j("uniforms.size_in_split_axis", "i", t1)}) {
        return i;
    }
    }
    return ${t1}u;
        ...
        let e = t1.length, r = [];
        for(let n = 0; n < e; ++n){
            let o = t1[n].setByIndices("indices", "input[global_idx]");
            e === 1 ? r.push(o) : n === 0 ? r.push(`if (output_number == ${n}u) { ${o} }`) : n === e - 1 ? r.push(`else { ${o} }`) : r.push(`else if (output_number == ${n}) { ${o} }`);
        }
        return `
      fn writeBufferData(output_number: u32, indices: ${t1[0].type.indices}, global_idx: u32) {
        ${r.join(`
`)}
      }`;
    }, Po = (t1, e)=>{
        let r = t1[0].dims, n = k.size(r), o = t1[0].dataType, i = k.normalizeAxis(e.axis, r.length), s = new Array(e.numOutputs), u = O("input", o, r.length), d = new Array(e.numOutputs), c = [], p = [], m = 0, g = [
            {
                type: 12,
                data: n
            }
  ...
  ${b.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
        ...
        Og(t1.inputs);
        let r = t1.inputs.length === 1 ? e : zg(t1.inputs, e);
        t1.compute(Po(t1.inputs, r), {
            inputs: [
                0
            ]
        });
    }, El = (t1)=>{
        let e = t1.axis, r = t1.splitSizes, n = t1.numOutputs < 0 ? r.length : t1.numOutputs;
...
var Mg, ln, kl, zo = V(()=>{
    ...
    oe();
    Mg = (t1, e)=>{
        let [r, n, o, i] = t1, { numHeads: s, rotaryEmbeddingDim: u } = e;
        ...
        let { interleaved: r, numHeads: n, rotaryEmbeddingDim: o, scale: i } = e, s = t1[0].dims[0], u = k.sizeFromDimension(t1[0].dims, 1), d = t1[0].dims[t1[0].dims.length - 2], c = u / d, p = t1[2].dims[1], m = o === 0 ? p * 2 : c / n, g = new Array(s, d, c / m, m - p), y = k.computeStrides(g), b = [
            {
                type: 1,
                data: i
            },
            ...
            ...W(t1[0].dims, t1[1].dims, t1[2].dims, t1[3].dims, t1[0].dims)
        ], _ = (T)=>{
            let x = O("input", t1[0].dataType, t1[0].dims.length), $ = O("position_ids", t1[1].dataType, t1[1].dims.length), S = O("cos_cache", t1[2].dataType, t1[2].dims.length), I = O("sin_cache", t1[3].dataType, t1[3].dims.length), E = U("output", t1[0].dataType, t1[0].dims.length);
        ...
        Mg(t1.inputs, e), t1.compute(ln(t1.inputs, e));
    };
});
var Rg, Ug, Pl, Ng, Ol, zl = V(()=>{
    ...
    oe();
    Rg = (t1, e)=>{
        if (e.doRotary && t1.length <= 7) throw new Error("cos_cache and sin_cache inputs are required if do_rotary is specified");
        let r = t1[0], n = t1[1], o = t1[2], i = t1[3], s = t1[4];
        if (e.doRotary !== 0 && t1.length <= 7) throw new Error("cos_cast and sin_cache are expected if do_rotary attribute is non-zero");
        ...
        if (r.dims.length !== 3 && r.dims.length !== 5) throw new Error("Input query is expected to have 3 or 5 dimensions");
        let u = !1, d = r.dims[0], c = r.dims[1], p = r.dims.length === 3 ? ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : r.dims[2] : e.numHeads * r.dims[4], m = c, g = 0, y = !n || n.dims.length === 0, b = Math.floor(y ? p / (e.numHeads + 2 * e.kvNumHeads) : p / e.numHeads);
        y && (p = b * e.numHeads);
        ...
        let o = 7, i = [
            ...
            let m = O("seq_lens", r.dataType, r.dims), g = O("total_seq_lens", n.dataType, n.dims), y = U("pos_ids", o, s), b = [
                {
                    name: "output_size",
                    type: "u32"
                },
  ...
  `;
        ...
        let r = Rg(t1.inputs, e);
        if (t1.inputs[0].dims.length === 5) throw new Error("Packed QKV is not implemented");
        if (t1.inputs[1]?.dims.length === 5) throw new Error("Packed KV is not implemented");
        let n = t1.inputs[0], o = t1.inputs[1] && t1.inputs[1].dims.length > 0 ? t1.inputs[1] : void 0, i = t1.inputs[2] && t1.inputs[2].dims.length > 0 ? t1.inputs[2] : void 0, s = t1.inputs[3] && t1.inputs[3].dims.length !== 0 ? t1.inputs[3] : void 0, u = t1.inputs[4] && t1.inputs[4].dims.length !== 0 ? t1.inputs[4] : void 0, d = t1.inputs.length > 4 ? t1.inputs[5] : void 0, c = t1.inputs.length > 5 ? t1.inputs[6] : void 0, p = r.kvNumHeads ? r.kvNumHeads : r.numHeads, m = ee({
            axis: 2,
            numOutputs: 3,
            splitSizes: [
        ...
        if (e.doRotary) {
            let I = t1.compute(Ng(r.batchSize, r.sequenceLength, d, c), {
                inputs: [
                    d,
                    c
                ],
            ...
            })[0], E = t1.inputs[7], A = t1.inputs[8], z = ee({
        ...
        let x = sr(t1, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, e.doRotary ? _ : g, void 0, 0), $ = Pl(t1, e.doRotary ? T : y, r), S = Pl(t1, b, r);
        Gt(t1, x, $, S, void 0, void 0, s, u, void 0, r, d, c);
    };
});
var Dl, Vg, Lg, Bl, Ml = V(()=>{
    ...
    Dl = (t1, e, r, n, o, i, s, u)=>{
        ...
        T.push(...W(y, b));
        let x = ($)=>{
            let S = O("x", e.dataType, 3, d), I = O("scale", r.dataType, r.dims), E = O("bias", n.dataType, n.dims), A = U("output", 1, 3, 2), z = [
                S,
                I,
                E,
                A
  ...
  ${$.mainStart(g)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
        ...
        let n = e[0].dims, o = n, i = 2, s = n[0], u = n[1], d = k.sizeFromDimension(n, i), c = fe(d), p = k.size(o) / c, m = Dl(t1, e[0], e[1], e[2], s, d, u, r.epsilon), g = [
            s,
            u,
            d / c
        ], y = [
  ...
  ${T.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${S.setByOffset("global_idx", "value")};
        ...
        g = g && n[n.length - 1] !== 1;
        let b = g ? t1.compute(De(t1.inputs[0], y), {
            inputs: [
                t1.inputs[0]
            ],
            outputs: [
        ...
        })[0] : t1.inputs[0].reshape(Array.from({
            length: n.length
        }, (x, $)=>n[y[$]])), _ = Dl(t1, b, e[1], e[2], i, u, s, r.epsilon), T = (x)=>{
  ...
  ${x.mainStart()}
    ...
    output[global_idx] = fma(input[global_idx], ${I(0)}, ${I(1)});
        ...
        e.format === "NHWC" ? Lg(t1, t1.inputs, e) : Vg(t1, t1.inputs, e);
    };
});
var Wg, Gg, Rl, Ul = V(()=>{
    "use strict";
    ...
    oe();
    Wg = (t1)=>{
        if (!t1 || t1.length < 2) throw new Error("layerNorm requires at least 2 inputs.");
    }, Gg = (t1, e, r)=>{
        let n = e.simplified, o = t1[0].dims, i = t1[1], s = !n && t1[2], u = o, d = k.normalizeAxis(e.axis, o.length), c = k.sizeToDimension(o, d), p = k.sizeFromDimension(o, d), m = k.size(i.dims), g = s ? k.size(s.dims) : 0;
       ...
       Got scale size of ${m} and bias size of ${g}`);
        ...
        s && _.push("type");
        let x = r > 1, $ = r > 2, S = (E)=>{
            let A = we(t1[0].dataType), z = [
                O("x", t1[0].dataType, t1[0].dims, b),
                O("scale", i.dataType, i.dims, b)
            ];
            s && z.push(O("bias", s.dataType, s.dims, b)), z.push(U("output", t1[0].dataType, u, b)), x && z.push(U("mean_data_output", 1, y)), $ && z.push(U("inv_std_output", 1, y));
            let v = [
                {
                    name: "norm_count",
                    type: "u32"
  ...
  ${E.mainStart()}
    ...
    ${$ ? "inv_std_output[global_idx] = inv_std_dev" : ""};
        ...
        Wg(t1.inputs), t1.compute(Gg(t1.inputs, e, t1.outputCount));
    };
});
var Hg, Nl, Vl = V(()=>{
    "use strict";
    ...
    sn();
    Hg = (t1)=>{
        if (!t1 || t1.length !== 2) throw new Error("MatMul requires 2 inputs.");
        if (t1[0].dims[t1[0].dims.length - 1] !== t1[1].dims[t1[1].dims.length - 2]) throw new Error("shared dimension does not match.");
    }, Nl = (t1)=>{
        Hg(t1.inputs);
        let e = ot.calcShape(t1.inputs[0].dims, t1.inputs[1].dims, !0);
        if (!e) throw new Error("Can't use matmul on the given tensors");
        let r = e[e.length - 1], n = t1.inputs[0].dims[t1.inputs[0].dims.length - 1];
        if (r < 8 && n < 8) t1.compute(on(t1.inputs, {
            activation: ""
        }, e));
        else {
            let o = e[e.length - 2], i = k.size(t1.inputs[0].dims.slice(0, -2)), s = k.size(t1.inputs[1].dims.slice(0, -2));
            if (i !== 1 && o === 1 && s === 1) {
                let u = t1.inputs[0].reshape([
                    1,
                    i,
                    n
                ]), d = t1.inputs[1].reshape([
                    1,
                    n,
                    r
                ]), c = [
...
var Fg, qg, Kg, Ll, Wl, Gl = V(()=>{
    ...
    oe();
    Fg = (t1, e)=>{
        if (t1.length < 3 || t1.length > 4) throw new Error("MatMulNBits requires 3 or 4 inputs");
        let r = t1[0], n = r.dims.length;
        if (r.dims[n - 1] !== e.k) throw new Error("The last dim of input shape does not match the k value");
        let o = Math.floor((e.k + e.blockSize - 1) / e.blockSize), i = e.blockSize / 8 * e.bits, s = t1[1];
        ...
        if (t1.length === 4) {
            let p = t1[3].dims, m = e.n * (e.bits === 8 ? o : Math.floor((o * e.bits + 7) / 8));
            if (k.size(p) !== m) throw new Error("zeroPoints input size error.");
        }
    }, qg = (t1, e)=>{
        let r = t1[0].dims, n = r.length, o = r[n - 2], i = e.k, s = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t1[1].dims[2] / 4, m = t1[0].dataType, g = fe(e.k), y = fe(p), b = fe(s), _ = u.concat([
            o,
            s
        ]), T = o > 1 && s / b % 2 === 0 ? 2 : 1, x = k.size(_) / b / T, $ = 64, S = [], I = [
            d,
            o,
            i / g
        ], E = k.convertShape(t1[1].dims).slice();
        E.splice(-1, 1, p / y), S.push(...W(I)), S.push(...W(E)), S.push(...W(t1[2].dims)), t1.length === 4 && S.push(...W(k.convertShape(t1[3].dims)));
        let A = [
            d,
            o,
            s / b
        ...
        S.push(...W(A));
        let z = (v)=>{
            let R = I.length, N = O("a", t1[0].dataType, R, g), F = O("b", 12, E.length, y), q = O("scales", t1[2].dataType, t1[2].dims.length), X = [
                N,
                F,
                q
            ], D = t1.length === 4 ? O("zero_points", 12, t1[3].dims.length) : void 0;
            D && X.push(D);
            let L = A.length, Q = U("output", t1[0].dataType, L, b), Y = we(t1[0].dataType), Z = (()=>{
                switch(g){
                    case 1:
                        return `array<${Y}, 8>`;
                    case 2:
          ...
          `;
            ...
            b_quantized_values = ${Z}(${Array.from({
                        length: 4
                    }, (Pe, he)=>`${Y}(b_value_lower[${he}]), ${Y}(b_value_upper[${he}])`).join(", ")});
            b_dequantized_values = ${g === 1 ? `${Z}(${Array.from({
                        length: 8
                    }, (Pe, he)=>`(b_quantized_values[${he}] - ${D ? `zero_point${$e}` : "zero_point"}) * scale${$e}`).join(", ")});` : `(b_quantized_values - ${Z}(${Array(8).fill(`${D ? `zero_point${$e}` : "zero_point"}`).join(",")})) * scale${$e};`};
            workgroup_shared[local_id.x * ${T} + ${Math.floor($e / b)}]${b > 1 ? `[${$e % b}]` : ""} += ${Array.from({
                        length: 8 / g
                    }, (Pe, he)=>`${g === 1 ? `a_data${G > 0 ? G : ""}[${he}] * b_dequantized_values[${he}]` : `dot(a_data${G > 0 ? G : ""}[${he}], b_dequantized_values[${he}])`}`).join(" + ")};
          `;
                }
                return M;
            }, Me = ()=>{
        ...
        return {
            ...
            shaderCache: {
                ...
                inputDependencies: Array(t1.length).fill("rank")
            },
            getRunData: ()=>({
                    outputs: [
                        {
        ...
        let r = t1[0].dims, n = r.length, o = r[n - 2], i = e.k, s = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t1[1].dims[2] / 4, m = t1[0].dataType, g = fe(e.k), y = fe(p), b = u.concat([
            o,
            s
        ]), _ = 128, T = s % 8 === 0 ? 8 : s % 4 === 0 ? 4 : 1, x = _ / T, $ = Math.floor(32 / e.bits), S = x * y * $, I = S / g, E = S / e.blockSize, A = k.size(b) / T, z = [], v = [
            d,
            o,
            i / g
        ], R = k.convertShape(t1[1].dims).slice();
        R.splice(-1, 1, p / y), z.push(...W(v)), z.push(...W(R)), z.push(...W(t1[2].dims)), t1.length === 4 && z.push(...W(k.convertShape(t1[3].dims)));
        let N = [
            d,
            o,
            s
        ...
        z.push(...W(N));
        let F = (q)=>{
            let X = v.length, D = O("a", t1[0].dataType, X, g), L = O("b", 12, R.length, y), Q = O("scales", t1[2].dataType, t1[2].dims.length), Y = [
                D,
                L,
                Q
            ], Z = t1.length === 4 ? O("zero_points", 12, t1[3].dims.length) : void 0;
            Z && Y.push(Z);
            let te = N.length, ae = U("output", t1[0].dataType, te), le = we(t1[0].dataType), Me = ()=>{
                switch(g){
                    case 1:
                        return `
          ...
          for (var tile: u32 = 0; tile < num_tiles; tile += 1) {
            ...
            for (var i: u32 = 0; i < ${y}; i++) {
              ...
              {${e.bits === 2 ? `
                ...
                let b_quantized_values = mat2x4<${le}>(${Array.from({
                        length: 4
                    }, ($e, Pe)=>`${le}(b_value_lower[${Pe}]), ${le}(b_value_upper[${Pe}])`).join(", ")});
                ...
                inter_results[local_id.y][local_id.x] += ${Array.from({
                        length: 2
                    }, ($e, Pe)=>`${`dot(a_data${Pe}, b_dequantized_values[${Pe}])`}`).join(" + ")};
              }
              word_offset += ${8 / g};`;
                }
                return M;
        ...
        Fg(t1.inputs, e), e.blockSize === 32 && t1.adapterInfo.isVendor("intel") && t1.adapterInfo.isArchitecture("gen-12lp") ? t1.compute(Kg(t1.inputs, e)) : t1.compute(qg(t1.inputs, e));
    }, Wl = (t1)=>ee(t1);
});
var jg, Zg, Qg, Yg, Xg, Jg, eb, tb, Hl, Fl = V(()=>{
    ...
    jg = (t1)=>{
        if (!t1 || t1.length < 1) throw new Error("Too few inputs");
        if (t1[0].dataType !== 1 && t1[0].dataType !== 10) throw new Error("Input type must be float or float16.");
        if (t1.length >= 2) {
            let e = t1[0].dims.length * 2 === t1[1].dims[0];
            if (t1.length === 4 && (e = t1[3].dims[0] * 2 === t1[1].dims[0]), !e) throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].");
        }
    }, Zg = (t1, e, r)=>{
        let n = "";
        for(let o = e - 1; o >= 0; --o)n += `
            k = i32(${t1.indicesGet("indices", o)}) - ${j("uniforms.pads", o, r)};
            if (k < 0) {
              break;
            }
        ...
        `;
        return `
          value = ${t1.type.value}(uniforms.constant_value);
          for (var i = 0; i < 1; i++) {
            var offset = 0;
            var k = 0;
            ${n}
      ...
      `;
        ...
        switch(r.mode){
            case 0:
                return Zg(t1, e, r.pads.length);
            case 1:
                return Qg(t1, e, r.pads.length);
            case 2:
                return Yg(t1, e, r.pads.length);
            case 3:
                return Xg(t1, e, r.pads.length);
            default:
                throw new Error("Invalid mode");
        }
    }, eb = (t1, e)=>{
        let r = k.padShape(t1[0].dims.slice(), e.pads), n = t1[0].dims, o = k.size(r), i = [
            {
                type: 12,
                data: o
            },
        ...
        ], s = t1.length >= 3 && t1[2].data;
        e.mode === 0 && i.push({
            type: s ? t1[2].dataType : 1,
            data: e.value
        }), i.push(...W(t1[0].dims, r));
        let u = [
            "rank"
        ], d = (c)=>{
            let p = U("output", t1[0].dataType, r.length), m = O("x", t1[0].dataType, n.length), g = m.type.value, y = Jg(p, n.length, e), b = [
                {
                    name: "output_size",
                    type: "u32"
                },
        ...
        if (t1.length > 1) {
            let r = t1[1].getBigInt64Array(), n = t1.length >= 3 && t1[2].data ? t1[2].dataType === 10 ? t1[2].getUint16Array()[0] : t1[2].getFloat32Array()[0] : 0, o = t1[0].dims.length, i = new Int32Array(2 * o).fill(0);
            if (t1.length >= 4) {
                let u = t1[3].getBigInt64Array();
        ...
        jg(t1.inputs);
        let r = tb(t1.inputs, e);
        t1.compute(eb(t1.inputs, r), {
            inputs: [
                0
            ]
        });
...
var cn, ql, Kl, jl, Zl, rb, nb, Ql, Yl, Xl, Jl, ec, tc, rc, nc, oc, ic, ac, sc, uc = V(()=>{
    ...
    oe();
    cn = (t1)=>{
        if (_e.webgpu.validateInputContent && (!t1 || t1.length !== 1)) throw new Error("Pool ops requires 1 input.");
    }, ql = (t1, e, r)=>{
        let n = e.format === "NHWC", o = t1.dims.slice();
        ...
        let r = e.format === "NHWC", n = k.size(t1), o = k.size(e.kernelShape), i = [
            {
                type: 12,
                data: n
            },
        ...
        if (o.kernelShape.length <= 2) {
            ...
            return `
            ${t1.registerUniforms(d).declareVariables(e, b)}

            ${t1.mainStart()}
              ${t1.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    }, Zl = (t1)=>`${t1.format};${t1.ceilMode};${t1.autoPad};${t1.kernelShape.length}`, rb = (t1)=>`${Zl(t1)};${t1.countIncludePad}`, nb = (t1)=>`${Zl(t1)};${t1.storageOrder};${t1.dilations}`, Ql = (t1)=>({
            format: t1.format,
            autoPad: [
                "NOTSET",
                "VALID",
            ...
            ceilMode: t1.ceil_mode,
            kernelShape: t1.kernel_shape,
            strides: t1.strides,
            pads: t1.pads
        }), Yl = (t1, e, r, n)=>{
        ...
        let e = t1.count_include_pad !== 0, r = Ql(t1);
        ...
        cn(t1.inputs), t1.compute(Yl("AveragePool", t1.inputs[0], !1, e));
    }, ec = {
        autoPad: "",
        ceilMode: 0,
        countIncludePad: !1,
        ...
        cn(t1.inputs), t1.compute(Yl("GlobalAveragePool", t1.inputs[0], !0, e));
    }, nc = (t1, e, r, n)=>{
        let [o, i] = ql(e, n, r), s = `
    ...
    `, u = "", d = O("x", e.dataType, e.dims.length), c = [
        ...
        cn(t1.inputs), t1.compute(nc("MaxPool", t1.inputs[0], !1, e));
    }, ic = (t1)=>{
        let e = t1.storage_order, r = t1.dilations, n = Ql(t1);
        ...
        cn(t1.inputs), t1.compute(nc("GlobalMaxPool", t1.inputs[0], !0, e));
    };
});
var ib, ab, dc, lc, cc = V(()=>{
    ...
    oe();
    ib = (t1, e)=>{
        if (t1.length < 2 || t1.length > 3) throw new Error("DequantizeLinear requires 2 or 3 inputs.");
        if (t1.length === 3 && t1[1].dims === t1[2].dims) throw new Error("x-scale and x-zero-point must have the same shape.");
        if (t1.length === 3 && t1[0].dataType !== t1[2].dataType) throw new Error("x and x-zero-point must have the same data type.");
        if (t1[1].dims.length !== 0 && t1[1].dims.length !== 1 && t1[1].dims.length !== t1[0].dims.length) throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");
        if (t1.length > 2) {
            if (t1[0].dataType !== t1[2].dataType) throw new Error("x and x-zero-point must have the same data type.");
            if (t1[1].dims.length !== t1[2].dims.length) throw new Error("scale and zero-point inputs must have the same rank.");
            if (!t1[1].dims.map((r, n)=>r === t1[2].dims[n]).reduce((r, n)=>r && n, !0)) throw new Error("scale and zero-point inputs must have the same shape.");
        }
        if (e.blockSize > 0) {
            if (t1[1].dims.length === 0 || t1[1].dims.length === 1 && t1[1].dims[0] === 1) throw new Error("blockSize must be set only for block quantization.");
            if (!t1[1].dims.map((o, i)=>i === e.axis || o === t1[0].dims[i]).reduce((o, i)=>o && i, !0)) throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");
            if (t1[1].dims.length !== t1[0].dims.length) throw new Error("For block qunatization the scale input rank must be the same as the x rank.");
            let r = t1[0].dims[e.axis], n = t1[1].dims[e.axis];
        ...
        let r = k.normalizeAxis(e.axis, t1[0].dims.length), n = t1[0].dataType, o = n === 3, i = t1[0].dims, s = t1[1].dataType, u = k.size(i), d = n === 3 || n === 2, c = d ? [
            Math.ceil(k.size(t1[0].dims) / 4)
        ] : t1[0].dims, p = t1[1].dims, m = t1.length > 2 ? t1[2] : void 0, g = m ? d ? [
            Math.ceil(k.size(m.dims) / 4)
        ] : m.dims : void 0, y = p.length === 0 || p.length === 1 && p[0] === 1, b = y === !1 && p.length === 1, _ = fe(u), T = y && (!d || _ === 4), x = T ? _ : 1, $ = T && !d ? _ : 1, S = O("input", d ? 12 : n, c.length, $), I = O("scale", s, p.length), E = m ? O("zero_point", d ? 12 : n, g.length) : void 0, A = U("output", s, i.length, x), z = [
            S,
            I
        ];
        E && z.push(E);
      ...
      ${A.setByOffset("global_idx", `${A.type.value}(x_value - zero_point_value) * scale_value`)};
        ...
        ib(t1.inputs, e), t1.compute(ab(t1.inputs, e));
    }, lc = (t1)=>ee({
            axis: t1.axis,
            blockSize: t1.blockSize
        });
...
var sb, ub, pc, mc = V(()=>{
    ...
    oe();
    sb = (t1, e, r)=>{
        let n = t1 === e, o = t1 < e && r < 0, i = t1 > e && r > 0;
        if (n || o || i) throw new Error("Range these inputs' contents are invalid.");
    }, ub = (t1, e, r, n)=>{
        let o = Math.abs(Math.ceil((e - t1) / r)), i = [
            o
        ], s = o, u = [
            {
                type: 12,
        ...
        let e = 0, r = 0, n = 0;
        t1.inputs[0].dataType === 6 ? (e = t1.inputs[0].getInt32Array()[0], r = t1.inputs[1].getInt32Array()[0], n = t1.inputs[2].getInt32Array()[0]) : t1.inputs[0].dataType === 1 && (e = t1.inputs[0].getFloat32Array()[0], r = t1.inputs[1].getFloat32Array()[0], n = t1.inputs[2].getFloat32Array()[0]), _e.webgpu.validateInputContent && sb(e, r, n), t1.compute(ub(e, r, n, t1.inputs[0].dataType), {
            inputs: []
        });
    };
});
var db, lb, fc, hc, gc = V(()=>{
    ...
    oe();
    db = (t1, e, r, n)=>{
        if (t1 !== "none" && n !== "i32" && n !== "u32" && n !== "f32") throw new Error(`Input ${n} is not supported with reduction ${t1}.`);
        let o = `{
                var oldValue = 0;
                loop {
                  let newValueF32 =`, i = `;
        ...
        switch(t1){
            ...
            default:
                throw new Error(`Reduction ${t1} is not supported.`);
        }
    }, lb = (t1, e)=>{
        let r = t1[0].dims, n = t1[1].dims, o = r, i = 1, s = Math.ceil(k.sizeToDimension(n, n.length - 1) / i), u = n[n.length - 1], d = k.sizeFromDimension(r, u), c = [
            {
                type: 12,
                data: s
            },
            ...
            ...W(t1[1].dims, t1[2].dims, o)
        ], p = (m)=>{
            let g = O("indices", t1[1].dataType, t1[1].dims.length), y = O("updates", t1[2].dataType, t1[2].dims.length, i), b = e.reduction !== "none" && e.reduction !== "" ? Ws("output", t1[0].dataType, o.length) : U("output", t1[0].dataType, o.length, i);
            return `
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${db(e.reduction, "output[data_offset + i]", "value", b.type.value)}
        ...
        return {
            ...
            reduction: t1.reduction
        }), hc = (t1, e)=>{
        t1.compute(lb(t1.inputs, e), {
            inputs: [
                t1.inputs[1],
                t1.inputs[2]
            ],
...
var cb, pb, mb, bc, fb, hb, gb, bb, yb, _b, wb, vb, yc, $b, xb, Sb, Tb, Ib, _c, wc, vc = V(()=>{
    ...
    cb = (t1, e)=>{
        if (t1.every((r)=>r > 0 || (()=>{
            ...
            if (e.mode === "linear") {
                if (!(t1.length === 2 || t1.length === 3 || t1.length === 4 && t1[0] === 1 && t1[1] === 1 || t1.length === 4 && t1[0] === 1 && t1[3] === 1 || t1.length === 5 && t1[0] === 1 && t1[1] === 1)) throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`);
            } else if (e.mode === "cubic" && !(t1.length === 2 || t1.length === 4 && t1[0] === 1 && t1[1] === 1 || t1.length === 4 && t1[0] === 1 && t1[3] === 1)) throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode");
        }
    }, pb = (t1, e, r)=>{
        e.every((o)=>o >= 0 && o < r || (()=>{
        ...
        return e.forEach((o, i)=>n[o] = t1[i]), n;
    }, mb = (t1, e, r, n, o, i)=>{
        let [s, u, d] = r > 10 ? [
            1,
            2,
        ...
        if (s > 0 && t1.length > s && t1[s].dims.length > 0) t1[s].getFloat32Array().forEach((p)=>i.push(p));
        ...
        if (u > 0 && t1.length > u && t1[u].dims.length === 1 && t1[u].dims[0] > 0) {
            if (t1[u].getFloat32Array().forEach((p)=>n.push(p)), n.length !== 0 && n.length !== c && r >= 18 && n.length !== e.axes.length) throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");
            cb(n, e), e.axes.length > 0 && pb(n, e.axes, c).forEach((p, m)=>n[m] = p);
        }
        if (d > 0 && t1.length > d && t1[d].dims.length === 1 && t1[d].dims[0] > 0 && (t1[d].getBigInt64Array().forEach((p)=>o.push(Number(p))), o.length !== 0 && o.length !== c && r >= 18 && o.length !== e.axes.length)) throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");
        if (e.axes.length > 0) {
  ...
  return whole + fract;
`, fb = (t1, e)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${e} { ` + (()=>{
        ...
        `;
                ...
                default:
                    throw new Error(`Coordinate transform mode ${t1} is not supported`);
            }
        })() + "}", hb = (t1, e, r)=>`fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {` + (()=>{
            switch(t1){
                ...
                default:
                    ...
                    throw new Error(`Nearest mode ${t1} is not supported`);
            }
        })() + "}", gb = (t1, e, r)=>{
        let n = new Array(r).fill(0).concat(new Array(r).fill(1)), o = t1.length === 0 ? n : t1.slice();
        ...
        e.fill(1, 0, e.length);
        let o = t1.slice();
        return r.axes.length > 0 ? (r.axes.forEach((i)=>e[i] = n), r.axes.forEach((i)=>o[i] = Math.round(t1[i] * e[i]))) : (e.fill(n, 0, e.length), o.forEach((i, s)=>o[s] = Math.round(i * e[s]))), o;
    }, _b = (t1, e, r, n, o)=>`
    fn calculateOriginalIndicesFromOutputIndices(output_indices: ${t1.type.indices}) -> array<${t1.type.value}, ${r.length}> {
      var original_indices: array<${t1.type.value}, ${r.length}>;
      for (var i:u32 = 0; i < ${r.length}; i++) {
        var output_index = ${t1.indicesGet("output_indices", "i")};
        var scale = ${j("uniforms.scales", "i", n)};
        var roi_low = ${j("uniforms.roi", "i", o)};
        var roi_hi = ${j("uniforms.roi", `i + ${e.length}`, o)};
        if (scale == 1.0) {
          original_indices[i] = ${t1.type.value}(output_index);
        } else {
    ...
    fn calculateInputIndicesFromOutputIndices(output_indices: ${e.type.indices}) -> ${t1.type.indices} {
      var input_indices: ${t1.type.indices};
      for (var i:u32 = 0; i < ${n.length}; i++) {
        ...
        ${t1.indicesSet("input_indices", "i", "input_index")}
      }
      return input_indices;
    }`, vb = (t1, e)=>`
    fn checkInputIndices(input_indices: ${t1.type.indices}) -> bool {
      for (var i:u32 = 0; i < ${e.length}; i++) {
        var input_index = ${t1.indicesGet("input_indices", "i")};
        if (input_index < 0 || input_index >= ${j("uniforms.input_shape", "i", e.length)}) {
          return false;
        }
      }
      return true;
    }`, yc = (t1, e, r, n)=>t1.rank > n ? `
    ${t1.indicesSet("input_indices", e, "channel")};
    ${t1.indicesSet("input_indices", r, "batch")};
` : "", $b = (t1, e, r, n, o)=>{
    ...
    fn getInputValue(batch: u32, channel: u32, row: u32, col: u32) -> ${p} {
      var input_indices: ${t1.type.indices};
      ${t1.indicesSet("input_indices", u, `max(0, min(row, ${r[u]} - 1))`)};
      ${t1.indicesSet("input_indices", d, `max(0, min(col, ${r[d]} - 1))`)};
      ${yc(t1, c, s, 2)}
      return ${t1.getByIndices("input_indices")};
    }
    ...
    }, xb = (t1, e, r, n, o, i, s, u, d, c)=>{
        let p = r.length === 2, m = !0, [g, y] = p ? [
            0,
            1
        ] : ("TURBOPACK compile-time truthy", 1) ? [
            2,
            3
        ] : "TURBOPACK unreachable", b = t1.type.value, _ = (T)=>{
            let x = T === g ? "row" : "col";
            return `
      fn ${x}CubicInterpolation(input_indices: ${t1.type.indices}, output_indices: ${e.type.indices}) -> ${b} {
        ...
        var input_indices_copy: ${t1.type.indices} = input_indices;
          ${t1.indicesSet("input_indices_copy", T, `u32(${x})`)};
          data[i + 1] = ${T === g ? t1.getByIndices("input_indices_copy") : "rowCubicInterpolation(input_indices_copy, output_indices)"};
        }
  ...
  fn bicubicInterpolation(output_indices: ${e.type.indices}) -> ${b} {
    var input_indices: ${t1.type.indices} = output_indices;
    ...
    fn getInputValue(batch: u32, channel: u32, depth:u32, height: u32, width: u32) -> ${m} {
      var input_indices: ${t1.type.indices};
      ${t1.indicesSet("input_indices", u, `max(0, min(depth, ${r[u]} - 1))`)};
      ${t1.indicesSet("input_indices", d, `max(0, min(height, ${r[d]} - 1))`)};
      ${t1.indicesSet("input_indices", c, `max(0, min(width, ${r[c]} - 1))`)};
      ${yc(t1, p, s, 3)}
      return ${t1.getByIndices("input_indices")};
    }
    ...
    depth = max(0, min(depth, ${r[u]} - 1));
      ...
      return (x111 * dx2 * dy2 * dz2 + x112 * dx2 * dy2 * dz1 + x121 * dx2 * dy1 *dz2 + x122 * dx2 * dy1 * dz1 +
        ...
        let s = t1.dims, u = gb(i, e.axes, s.length), d = bb(s, n, o, e.axes), c = n.slice();
        n.length === 0 && (c = s.map(($, S)=>$ === 0 ? 1 : d[S] / $), e.keepAspectRatioPolicy !== "stretch" && (d = yb(s, c, e)));
        let p = U("output", t1.dataType, d.length), m = O("input", t1.dataType, s.length), g = k.size(d), y = s.length === d.length && s.every(($, S)=>$ === d[S]), b = e.coordinateTransformMode === "tf_crop_and_resize", _ = e.extrapolationValue, T = m.type.value, x = ($)=>`
      ${y ? "" : `
...
`}
        ...
        mb(t1.inputs, e, i, r, n, o), t1.compute(Tb(t1.inputs[0], e, i, r, n, o), {
            inputs: [
                0
            ]
        });
    }, wc = (t1)=>{
        let e = t1.antialias, r = t1.axes, n = t1.coordinateTransformMode, o = t1.cubicCoeffA, i = t1.excludeOutside !== 0, s = t1.extrapolationValue, u = t1.keepAspectRatioPolicy, d = t1.mode, c = t1.nearestMode === "" ? "simple" : t1.nearestMode;
        return ee({
            antialias: e,
            axes: r,
...
var Cb, Ab, $c, xc = V(()=>{
    ...
    oe();
    Cb = (t1)=>{
        if (!t1 || t1.length < 3) throw new Error("layerNorm requires at least 3 inputs.");
        let e = t1[0], r = t1[1], n = t1[2];
        ...
        let o = e.simplified, i = t1[0].dims, s = k.size(i), u = i, d = s, c = i.slice(-1)[0], p = n ? i.slice(0, -1).concat(1) : [], m = !o && t1.length > 3, g = t1.length > 4, y = n && r > 1, b = n && r > 2, _ = r > 3, T = 64, x = fe(c), $ = [
            {
                type: 12,
                data: d
            },
            ...
            let A = [
                ...
                O("x", t1[0].dataType, t1[0].dims, x),
                O("skip", t1[1].dataType, t1[1].dims, x),
                O("gamma", t1[2].dataType, t1[2].dims, x)
            ];
            m && z.push(O("beta", t1[3].dataType, t1[3].dims, x)), g && z.push(O("bias", t1[4].dataType, t1[4].dims, x)), z.push(U("output", t1[0].dataType, u, x)), y && z.push(U("mean_output", 1, p)), b && z.push(U("inv_std_output", 1, p)), _ && z.push(U("input_skip_bias_sum", t1[0].dataType, u, x));
            let v = we(t1[0].dataType), R = we(1, x);
            return `
      ...
      ${E.mainStart([
        ...
        return r > 1 && I.push({
            ...
            shaderCache: {
                hint: `${x};${y};${b};${_}`,
                inputDependencies: t1.map((E, A)=>"type")
            },
            getShaderSource: S,
            getRunData: ()=>({
                    outputs: I,
        ...
        t1.outputCount > 1 && n.push(-3), t1.outputCount > 2 && n.push(-3), t1.outputCount > 3 && n.push(3), t1.compute(Ab(t1.inputs, e, t1.outputCount, !1), {
            outputs: n
        });
    };
});
var Eb, pn, kb, Sc, Pb, Ob, Tc, Ic, Cc = V(()=>{
    ...
    Eb = (t1, e)=>{
        ...
        t1.slice(1).forEach((r, n)=>{
            if (t1[n + 1].dataType !== 6 && t1[n + 1].dataType !== 7) throw new Error(`Input ${n} must be an array of int32 or int64`);
        });
    }, pn = (t1, e)=>{
        let r = [];
        if (t1.length > e) if (t1[e].dataType === 7) t1[e].getBigInt64Array().forEach((n)=>r.push(Number(n)));
        else if (t1[e].dataType === 6) t1[e].getInt32Array().forEach((n)=>r.push(Number(n)));
        else throw new Error(`Input ${e} must be an array of int32 or int64`);
        return r;
    }, kb = (t1, e)=>{
        if (t1.length > 1) {
            let r = pn(t1, 1), n = pn(t1, 2), o = pn(t1, 3);
            return o.length === 0 && (o = [
                ...Array(t1[0].dims.length).keys()
            ]), ee({
                starts: r,
                ends: n,
                axes: o
        ...
        let i = t1;
        return t1 < 0 && (i += r[n[e]]), o[e] < 0 ? Math.max(0, Math.min(i, r[n[e]] - 1)) : Math.max(0, Math.min(i, r[n[e]]));
    }, Pb = (t1, e, r)=>`fn calculateInputIndices(output_indices: ${e.type.indices}) -> ${t1.type.indices} {
          var input_indices: ${t1.type.indices};
          var carry = 0u;
        ...
        let r = t1[0].dims, n = k.size(r), o = e.axes.length > 0 ? k.normalizeAxes(e.axes, r.length) : [
            ...Array(r.length).keys()
        ], i = pn(t1, 4);
        i.forEach((x)=>x !== 0 || (()=>{
        ...
        let p = {
            dims: c,
            dataType: t1[0].dataType
        }, m = U("output", t1[0].dataType, c.length), g = O("input", t1[0].dataType, t1[0].dims.length), y = k.size(c), b = [
            {
                name: "outputSize",
                type: "u32"
            },
      ...
      ${x.registerUniforms(b).declareVariables(g, m)}
        ...
        Eb(t1.inputs, e);
        let r = kb(t1.inputs, e);
        t1.compute(Ob(t1.inputs, r), {
            inputs: [
                0
            ]
        });
    }, Ic = (t1)=>{
        let e = t1.starts, r = t1.ends, n = t1.axes;
        return ee({
            starts: e,
            ends: r,
            axes: n
...
var zb, Db, Ac, Ec, kc = V(()=>{
    ...
    oe();
    zb = (t1)=>{
        if (!t1 || t1.length !== 1) throw new Error("Softmax op requires 1 input.");
    }, Db = (t1, e)=>{
        let r = t1.inputs[0], n = r.dims, o = k.size(n), i = n.length, s = k.normalizeAxis(e.axis, i), u = s < n.length - 1, d, c = [];
        u ? (c = Array.from({
            length: i
        }, (z, v)=>v), c[s] = i - 1, c[i - 1] = s, d = t1.compute(De(r, c), {
            inputs: [
                r
            ],
            outputs: [
...
var Pc, Bb, Mb, Rb, Oc, zc = V(()=>{
    ...
    re();
    oe();
    Pc = (t1)=>Array.from(t1.getBigInt64Array(), Number), Bb = (t1)=>{
        if (!t1 || t1.length !== 2) throw new Error("Tile requires 2 inputs.");
        if (t1[0].dataType !== 1 && t1[0].dataType !== 10 && t1[0].dataType !== 6 && t1[0].dataType !== 12) throw new Error("Tile only support float, float16, int32, and uint32 data types");
        if (t1[1].dataType !== 7) throw new Error("Tile `repeats` input should be of int64 data type");
        if (t1[1].dims.length !== 1) throw new Error("Tile `repeats` input should be 1-D");
        if (Pc(t1[1]).length !== t1[0].dims.length) throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor");
    }, Mb = (t1, e)=>{
        let r = [];
        for(let n = 0; n < t1.length; ++n)r.push(t1[n] * e[n]);
        return r;
    }, Rb = (t1, e)=>{
        let r = t1[0].dims, n = e ?? Pc(t1[1]), o = Mb(r, n), i = k.size(o), s = t1[0].dataType, u = O("input", s, r.length), d = U("output", s, o.length), c = (p)=>`
      ...
      ${d.setByOffset("global_idx", u.getByIndices("input_indices"))}
        ...
        Bb(t1.inputs), t1.compute(Rb(t1.inputs), {
            inputs: [
                0
            ]
        });
...
var Ub, Nb, Dc, Bc = V(()=>{
    ...
    Ub = (t1, e, r, n, o)=>{
        ...
        return `
        ${t1.registerUniform("vec_size", "u32").declareVariables(d, s, u, i)}
        ${t1.mainStart()}
        ${t1.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${c}
      }`;
    }, Nb = (t1)=>{
        let e = t1[1].dims, r = t1[2].dims, n = t1[0].dims, o = t1[1].dataType, i = !(k.areEqual(e, r) && k.areEqual(r, n)), s = e, u = k.size(e);
        if (i) {
        ...
        return {
            ...
            getShaderSource: (c)=>Ub(c, t1, s, i, o),
            getRunData: ()=>({
                    outputs: [
                        {
                            dims: s,
...
var Vb, Lb, Do, Bo, Vc = V(()=>{
    ...
    Uc();
    Vb = (t1, e)=>{
        if (e.length !== t1.length) throw new Error(`inputDependencies length ${e.length} is not equal to inputTensors length ${t1.length}.`);
        let r = [];
        for(let n = 0; n < t1.length; ++n){
            ...
            switch(e[n]){
                ...
                case "rank":
                    {
                        let i = t1[n].dims.length;
                        r.push(`${o};${i}`);
                        break;
                    }
                case "dims":
                    {
                        let i = t1[n].dims.join(",");
                        r.push(`${o};${i}`);
                        break;
                    }
                default:
        ...
        let n = t1.name;
        return t1.shaderCache?.hint && (n += "[" + t1.shaderCache.hint + "]"), n += ":" + r + `:${Vb(e, t1.shaderCache?.inputDependencies ?? new Array(e.length).fill("dims"))}`, n;
    }, Do = class {
        constructor(e){
        ...
        async initialize(e, r) {
            ...
            i("chromium-experimental-timestamp-query-inside-passes") || i("timestamp-query"), i("shader-f16"), i("subgroups"), this.device = await r.requestDevice(o), this.adapterInfo = new Do(r.info || await r.requestAdapterInfo()), this.gpuDataManager = Vs(this), this.programManager = new mn(this), this.kernels = new Map, this.kernelPersistentData = new Map, this.kernelCustomData = new Map, Lr(e.logLevel, !!e.debug), this.device.onuncapturederror = (s)=>{
        ...
        run(e, r, n, o, i, s) {
            ...
            if (p) {
                ...
                p.forEach((v, R)=>{
                    let N = I[R], F = typeof v.data == "number" ? [
                        v.data
                    ] : v.data;
...
var ur, Mo, Wb, Wc = V(()=>{
    ...
    ur = class t1 {
        ...
        reshape(e) {
            ...
            return new t1(this.module, this.dataType, this.data, e);
        }
    }, Mo = class {
        constructor(e, r, n){
            this.module = e;
...
var Gb, kr, Pr, Mt, Hb, Gc, er, Or, zr, Hc, Dr, Br, Mr, Qn = V(()=>{
    ...
    ro();
    Gb = (t1, e)=>{
        ye()._OrtInit(t1, e) !== 0 && me("Can't initialize onnxruntime.");
    }, kr = async (t1)=>{
        Gb(t1.wasm.numThreads, rr(t1.logLevel));
    }, Pr = async (t1, e)=>{
        ye().asyncInit?.();
        let r = t1.webgpu.adapter;
        if (e === "webgpu") {
        ...
        {
            let n = (Wc(), Xt(Lc)).init;
            e === "webgpu" && await n("webgpu", ye(), t1, r), e === "webnn" && await n("webnn", ye(), t1);
        }
    }, Mt = new Map, Hb = (t1)=>{
        let e = ye(), r = e.stackSave();
        try {
            let n = e.PTR_SIZE, o = e.stackAlloc(2 * n);
            e._OrtGetInputOutputCount(t1, o, o + n) !== 0 && me("Can't get session input/output count.");
            let s = n === 4 ? "i32" : "i64";
            return [
        ...
        try {
            ...
            r._OrtGetInputOutputMetadata(t1, e, s, s + i) !== 0 && me("Can't get session input/output metadata.");
        ...
        let e = ye(), r = e._malloc(t1.byteLength);
        if (r === 0) throw new Error(`Can't create a session. failed to allocate a buffer of size ${t1.byteLength}.`);
        return e.HEAPU8.set(t1, r), [
            r,
            t1.byteLength
        ];
    }, Or = async (t1, e)=>{
        let r, n, o = ye();
        Array.isArray(t1) ? [r, n] = t1 : t1.buffer === o.HEAPU8.buffer ? [r, n] = [
            t1.byteOffset,
            t1.byteLength
        ] : [r, n] = er(t1);
        ...
        let e = ye(), r = Mt.get(t1);
        if (!r) throw new Error(`cannot release session. invalid session id: ${t1}`);
        let [n, o, i, s, u] = r;
        s && (u && e._OrtClearBoundOutputs(s.handle) !== 0 && me("Can't clear bound outputs."), e._OrtReleaseBinding(s.handle) !== 0 && me("Can't release IO binding.")), e.jsepOnReleaseSession?.(t1), e.webnnOnReleaseSession?.(t1), e.webgpuOnReleaseSession?.(t1), o.forEach((d)=>e._OrtFree(d)), i.forEach((d)=>e._OrtFree(d)), e._OrtReleaseSession(n) !== 0 && me("Can't release session."), Mt.delete(t1);
    }, Hc = async (t1, e, r, n, o, i, s = !1)=>{
        if (!t1) {
            e.push(0);
            return;
        }
        let u = ye(), d = u.PTR_SIZE, c = t1[0], p = t1[1], m = t1[3], g = m, y, b;
    ...
    }, Dr = async (t1, e, r, n, o, i)=>{
        let s = ye(), u = s.PTR_SIZE, d = Mt.get(t1);
        if (!d) throw new Error(`cannot run inference. invalid session id: ${t1}`);
        ...
        try {
            ...
            for(let L = 0; L < _; L++)await Hc(r[L], S, E, t1, p[e[L]], e[L], y);
            for(let L = 0; L < T; L++)await Hc(o[L], I, E, t1, m[n[L]], _ + n[L], y);
            ...
            if (g && !b) {
                ...
                for(let Z = 0; Z < _; Z++){
                    let te = e[Z];
                    await s._OrtBindInput(L, p[te], S[Z]) !== 0 && me(`Can't bind input[${Z}] for session=${t1}.`);
                }
                for(let Z = 0; Z < T; Z++){
                    let te = n[Z];
                    o[Z]?.[3] ? (A.push(I[Z]), s._OrtBindOutput(L, m[te], I[Z], 0) !== 0 && me(`Can't bind pre-allocated output[${Z}] for session=${t1}.`)) : s._OrtBindOutput(L, m[te], 0, Y[te]) !== 0 && me(`Can't bind output[${Z}] to ${Q[Z]} for session=${t1}.`);
                }
                wt("wasm bindInputsOutputs"), Mt.set(t1, [
                    c,
                    p,
                    m,
                    g,
            ...
            for(let L = 0; L < T; L++){
                ...
                try {
                    ...
                    if (ae === "string") {
                        ...
                        if (!Te(t1, ae, !1)) throw new Error(`preferredLocation "ml-tensor" for ${ae} output is not supported by current WebNN Context.`);
                        let Ne = await he(t1, le, M, Ee, !1);
                        te = !0, X.push([
                            ae,
                            Ee,
                            {
            ...
            g && !y && (s._OrtClearBoundOutputs(g.handle) !== 0 && me("Can't clear bound outputs."), Mt.set(t1, [
                c,
                p,
                m,
                g,
...
var Rt, Fe, dr, hn, gn, fn, Ro, Uo, qt, Kt, qb, Fc, qc, Kc, jc, Zc, Qc, Yc, No = V(()=>{
    ...
    vt();
    Ar();
    Rt = ()=>!!_e.wasm.proxy && typeof document < "u", dr = !1, hn = !1, gn = !1, Uo = new Map, qt = (t1, e)=>{
        let r = Uo.get(t1);
        r ? r.push(e) : Uo.set(t1, [
            e
        ]);
    }, Kt = ()=>{
        ...
        switch(t1.data.type){
            case "init-wasm":
                dr = !1, t1.data.err ? (gn = !0, Ro[1](t1.data.err)) : (hn = !0, Ro[0]()), fn && (URL.revokeObjectURL(fn), fn = void 0);
                break;
            case "init-ep":
            case "copy-from":
            case "create":
            ...
            case "end-profiling":
                {
                    let e = Uo.get(t1.data.type);
                    t1.data.err ? e.shift()[1](t1.data.err) : e.shift()[0](t1.data.out);
                    break;
                }
            default:
        }
        ...
        if (!hn) {
            ...
            if (dr = !0, Rt()) return new Promise((t1, e)=>{
                Fe?.terminate(), _s().then(([r, n])=>{
                    try {
                        Fe = n, Fe.onerror = (i)=>e(i), Fe.onmessage = qb, Ro = [
                            t1,
                            e
                        ];
                        let o = {
                        ...
                        !o.in.wasm.wasmPaths && (r || Xn) && (o.in.wasm.wasmPaths = {
                            wasm: new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm (static in ecmascript, tag client)")).href
                        }), Fe.postMessage(o), fn = r;
                    } catch (o) {
                        e(o);
                    }
                }, e);
        ...
        await Pr(_e, t1);
    }, Kc = async (t1)=>Rt() ? (Kt(), new Promise((e, r)=>{
            qt("copy-from", [
                e,
                r
            ]);
        ...
        if (Rt()) {
            ...
            return Kt(), new Promise((r, n)=>{
                ...
                t1 instanceof Uint8Array && i.push(t1.buffer), Fe.postMessage(o, i);
            });
        } else return Or(t1, e);
    }, Zc = async (t1)=>{
        if (Rt()) return Kt(), new Promise((e, r)=>{
...
var Xc, Kb, bn, Jc = V(()=>{
    ...
    Xc = (t1, e)=>{
        switch(t1.location){
            ...
            default:
                throw new Error(`invalid data location: ${t1.location} for ${e()}`);
        }
    }, Kb = (t1)=>{
        switch(t1[3]){
            case "cpu":
                return new je(t1[0], t1[2], t1[1]);
            case "gpu-buffer":
                {
                    let e = t1[0];
                    if (!Nr(e)) throw new Error(`not supported data type: ${e} for deserializing GPU tensor`);
                    let { gpuBuffer: r, download: n, dispose: o } = t1[2];
            ...
            case "ml-tensor":
                {
                    ...
                    let { mlTensor: r, download: n, dispose: o } = t1[2];
            ...
            default:
                throw new Error(`invalid data location: ${t1[3]}`);
        }
    }, bn = class {
...
var ep, yn, jb, rp = V(()=>{
    ...
    ep = ()=>{
        ...
        let t1 = _e.wasm.simd;
        if (typeof t1 != "boolean" && t1 !== void 0 && t1 !== "fixed" && t1 !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${t1}". Reset it to \`false\` and ignore SIMD feature checking.`), _e.wasm.simd = !1), typeof _e.wasm.proxy != "boolean" && (_e.wasm.proxy = !1), typeof _e.wasm.trace != "boolean" && (_e.wasm.trace = !1), typeof _e.wasm.numThreads != "number" || !Number.isInteger(_e.wasm.numThreads) || _e.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) _e.wasm.numThreads = 1;
        else {
...
var iT = Zn;
{
    let t1 = (rp(), Xt(tp)).wasmBackend;
    kt("webgpu", t1, 5), kt("webnn", t1, 5), kt("cpu", t1, 10), kt("wasm", t1, 10);
...
//# sourceMappingURL=node_modules_onnxruntime-web_dist_0rrkpzn._.js.map